    // Student Image Crope   
    $('#logo_img_input').change(function(event) 
    {
        var $modal = $('#schoolo-logo-modal');
        var image = document.getElementById('schoolo-logo-sample-img');
        var cropper;
        ...
        if (files && files.length > 0) {
            ...
            $('#schoolo_logo_preview').attr("src",  "http://bit.ly/3IUenmf");
        }
        ...
        $("#logo-crop").click(function() {
            ...
            canvas.toBlob(function(blob) {
                ...
                reader.onloadend = function() {
                    ...
                    $modal.modal('hide');
                    $('#schoolo_logo_preview').attr('src', base64data);
                    ...
                    if (cropped) {
                        ...
                        $.ajax({
                            ...
                            success: function(data){
                                ...
                                $('#schoolo_logo_preview').attr('src', currentDomainWithProtocol+'/storage/' + data.path + '?' + timestamp);
                            },
