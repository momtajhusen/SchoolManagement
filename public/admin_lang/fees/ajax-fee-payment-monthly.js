  ...
  $(".search-btn").click(function () {
      ...
      if (student_id != "") 
      {
          $.ajax({
              ...
              beforeSend: function() 
              {
                $('.search-btn').html('<i class="fa fa-circle-o-notch fa-spin" style="font-size:13px"></i>');
              },
                ...
                $('.search-btn').html('SEARCH');
                  ...
                  if (response.data) 
                  {
                    ...
                    $(".invoice-box").removeClass("d-none");
                      ...
                      $("#roll").val(roll_no);
                      $('#roll_update').attr('st_id', student_id);
                  ...
                  // Start Payment History data in table 
                    $(".history-table").html(``);
                      ...
                      response.PaymentHistory.forEach(function()
                      {
                          ...
                          var processed_by = response.PaymentHistory[increase].processed_by ?? '';
