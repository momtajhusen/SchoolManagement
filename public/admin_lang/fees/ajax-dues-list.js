// Search Btn click foe dueslist search  
...
$(document).ready(function(){
    $(".message-send-btn").click(function(){
        var StudentData = [];
        $(".dues").each(function(){
             if($(this).attr("father_mobile") != "#")
             {
                var father_mobile = $(this).attr("father_mobile");
                var dues_amount = $(this).html();
                var totalfee = $(this).attr("totalfee");
                var payment = $(this).attr("payment");
                var student = $(this).attr("student");
                // push a new array with the four values into StudentData
                StudentData.push([father_mobile, student, totalfee, payment, dues_amount]);
             }
        });
        console.log(StudentData); // output the final array for testing purposes
...
$(document).ready(function() {
    ...
    for (var i = 0; i <= decremented_current_month; i++) {
