    ...
    $(document).ready(function() {
        $("#join-month-save").click(function() {
            ...
            // Start  One time Fee Stracture Joining 
                ...
                $("[name^='hosteldeposit-']").each(function() {
                    var number = parseInt($(this).attr("id").split("-")[1]);
                    hostelDepositArray[number - 1] = $(this).is(":checked") ? 1 : 0;
                });
            ...
            hostelDepositArray = hostelDepositArray.filter(function(item) {
                return item !== undefined;
            });
    ...
    $("#joining-btn").click(function(){
        ...
        $.ajax({
            ...
            if (response.join_months === "No data found") {
                ...
                var hosteldepositArray = response.join_months.hostelDepositArray;
                ...
                $("[id^='hosteldeposit-']").each(function(index) {
                    $(this).prop("checked", hosteldepositArray[index] === '1');
                });
