                ...
                success: function (response) {
                    ...
                    if (response.message != "Student not found") 
                    {
                      $("#payment-history").removeClass("d-none");
                        ...
                        $("#student_image").attr("src", currentDomainWithProtocol+"/storage/"+imgpath);
                        $("#name").html(student_name);
                        $("#class").html(classes);
                        $("#roll").html(roll_no);
                        $("#hostel_outi").html(hostel_outi);
                        $("#transport_use").html(transport_use);
                        ...
                        response.PaymentHistory.forEach(function()
                        {
                            ...
                            `);
                              ...
                              <tr>
                                 ...
                                 <td scope="row">`+pay_date+`</td>
                                 <td scope="row">
                                   <button class="btn px-2 d-flex justify-content-center aligin-items-center" id="bill-btn" history_id="`+history_id+`" student_id="`+student_id+`" month="`+months+`" style="font-size:15px;" data-toggle="modal" data-target="#staticBackdrop">
                                     <span>Bill Print</span> <span class="material-symbols-outlined ml-1" style="font-size:15px;margin-top:2px;">print</span> 
                                   </button>
                                 </td>
                              </tr> 
