               ...
               <td>
                  <div class="dropdown">
                      ...
                      <div class="dropdown-menu dropdown-menu-right">
                          <a class="dropdown-item" style="cursor:pointer"><i class="fas fa-times text-orange-red"></i>Close</a>
                          <a class="dropdown-item edit-subject" subject_id="` +
                          subject_id +
                          `" style="cursor:pointer"><i class="fas fa-cogs text-dark-pastel-green"></i>Edit</a>
                          <a class="dropdown-item delete-subject" subject_id="` +
                            subject_id +
                            `" style="cursor:pointer"><i class="fas fa-trash text-dark-pastel-green"></i>Delete</a>
                          <a class="dropdown-item" style="cursor:pointer"><i class="fas fa-redo-alt text-orange-peel"></i>Refresh</a>
                      </div>
                  </div>
              </td>
          </tr>`
