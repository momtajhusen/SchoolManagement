        ...
        data:{
         ...
         success:function(response)
         {
            ...
            if(response.message == 'parent not found'){
               $('.main-content').html(`
                  <h1 class='text-center border px-5'>${response.message}</h1>
               `);
            }
            ...
            // Student Data 
             ...
             response.student_data.forEach(function (data) {
                ...
                <div class="mb-2 d-flex justify-content-between p-3 students" st_id=`+st_id+`>
                    <div class="d-flex">
                        <img class='hover-image-preview' src="`+currentDomainWithProtocol+`/storage/`+st_image+`" alt="" style="width:40px;height:40px;border:1px solid black;">
