...
// if session exists -> account_management || student_management || super_admin || school_management
   Route::group(['middleware' => 'AdminCommonGetPost'], function () {
      ...
      Route::post('/manual-update-student', 'App\Http\Controllers\StudentController@ManualUpdateStudent');
...
///////////////////////////// Start Super Admin /////////////////////////////
   ...
   Route::get('/manual-login', 'App\Http\Controllers\AccountLoginController@Manuallogin');


   //Super Admin Verify 
   Route::post('/super-admin-verify', 'App\Http\Controllers\AccountLoginController@SuperAdminVerify');
   //Super Admin Logout 
   ...
   // Developer 
      ...
      Route::post('/set-new-account-student-fee', 'App\Http\Controllers\DeveloperController@NewAccountStudentFeeSet');

      Route::get('/date-change', 'App\Http\Controllers\DeveloperController@DateChange');
   ...
   // Start Super Admin Account management
      ...
      Route::view('admin/fee-ledger', 'Admin_Page/Super_Admin/layouts/Reports_Area/fee-ledger')->name('fee-ledger');

      Route::get('admin/get-fee-ledger', 'App\Http\Controllers\ReporstArea@feeLedger');
      ...
      Route::get('/get-hostel-deposit', 'App\Http\Controllers\ReporstArea@hostelDeposit');
   ...
   // Start New Account Management 

         // Student Fee Payment 
         Route::view('admin/student-fee-payment', 'Admin_Page/Super_Admin/layouts/New_Account_Management/Student_Fee_Payment/student-fee-payment')->name('student-fee-payment');
         Route::view('admin/student-deus-fee-list', 'Admin_Page/Super_Admin/layouts/New_Account_Management/Student_Fee_Payment/student-deus-fee-list')->name('student-deus-fee-list');
         ...
         Route::get('/get-student-admission-year', 'App\Http\Controllers\HelperController\StudentAccountFee@StudentAdmissionYear');

         Route::get('/get-student-fee-month-year', 'App\Http\Controllers\HelperController\StudentAccountFee@StudentFeeMonthYear');



         // Report Area
         Route::view('admin/new-fee-collection-reports', 'Admin_Page/Super_Admin/layouts/New_Account_Management/Report_Area/fee-collection-reports')->name('new-fee-collection-reports');
         Route::view('admin/new-financial-overview', 'Admin_Page/Super_Admin/layouts/New_Account_Management/Report_Area/financialOverview')->name('new-financial-overview');
   
 
         Route::get('/get-new-collection-history', 'App\Http\Controllers\NewAccountController\NewReporstArea@CollectionReport');
         Route::get('/get-new-collection-date-wize', 'App\Http\Controllers\NewAccountController\NewReporstArea@CollectionDateWize');
         Route::get('/get-new-collection-student-wize', 'App\Http\Controllers\NewAccountController\NewReporstArea@CollectionStudentWize');
 

         
         Route::get('/new-financial-overview', 'App\Http\Controllers\NewAccountController\NewReporstArea@financialOverview');
   ...
   Route::post('/admin/save-default-fee', 'App\Http\Controllers\ParrentProfile@SaveDefault');
   ...
   Route::post('/manual-update-parent', 'App\Http\Controllers\ParentsController@manualUpdateParent');

   Route::post('/delete-parent', 'App\Http\Controllers\ParentsController@DeleteParent');

   Route::post('/change-parent', 'App\Http\Controllers\ParentsController@ChangeParent');
   ...
   Route::post('/roll-upddate', 'App\Http\Controllers\StudentController@RollUpdate');
   ...
   Route::view('admin/complaint', 'Admin_Page/Super_Admin/layouts/Feedback_Complaint/complaint')->name('complaint');
   Route::view('admin/feedback', 'Admin_Page/Super_Admin/layouts/Feedback_Complaint/feedback')->name('feedback');

   Route::post('/complaint-audio', 'App\Http\Controllers\ComplaintFeedbackController@ComplaintAudio');
   Route::post('/complaint-message', 'App\Http\Controllers\ComplaintFeedbackController@ComplaintMessage');


   Route::get('/get-all-retrive-complain-list', 'App\Http\Controllers\ComplaintFeedbackController@getAllRetriveComplainList');
   ...
   Route::view('admin/add_super_admin', 'Admin_Page/Super_Admin/layouts/RoleAndPermission/add_super_admin')->name('add_super_admin');
   ...
   Route::post('/admin/add-super-admin', 'App\Http\Controllers\RoleAndPermissionController@AddSuperAdmin');
   ...
   Route::get('/admin/super-admin-list', 'App\Http\Controllers\RoleAndPermissionController@SuperAdminList');
