                            ...
                            <form class="student-update-form" enctype="multipart/form-data">
                                <div class="row">
                                    ...
                                    <div class="col-xl-3 col-lg-6 col-12 form-group">
                                        ...
                                        <input type="text" required name="admission_date" placeholder="dd/mm/yyyy" class="form-control admission_date">
                                        <i class="far fa-calendar-alt" style="position:absolute;top:45px;right:30px;"></i>
                                    </div>
...
<?php echo $__env->make('Admin_Page/Super_Admin/admin_template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u569470620/domains/mustlearn.in/public_html/Developer/resources/views/Admin_Page/Super_Admin/layouts/Student_Management/update_student_details.blade.php ENDPATH**/ ?>