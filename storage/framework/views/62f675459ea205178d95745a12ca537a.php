                ...
                <ul class="navbar-nav">
                    <li class="navbar-item header-search-bar">
                        <div class="d-flex align-items-start flex-column">
                            ...
                            <div style="color: #bdbdbd; font-size:15px;"><b>Date :</b> <b id="current_date_header"></b> </div>
                        </div>
                    </li>
                </ul>
                <ul class="navbar-nav">
                        ...
                        <li class="nav-item sidebar-nav-item">
                            ...
                            <ul class="nav sub-group-menu">
                                ...
                                <li class="nav-item deve-use">
                                    <a href="<?php echo e(route('manage-stracture')); ?>" class="nav-link"><i class="fas fa-angle-right"></i>New Fee Structure</a>
                                </li>
                                <li class="nav-item">
                                ...
                                <li class="nav-item deve-use">
                                    <a href="<?php echo e(route('discount-manage')); ?>" class="nav-link"><i class="fas fa-angle-right"></i>
                                    Discount Exceptions</a>
                                </li>

                                <li class="nav-item">
                                    <a href="<?php echo e(route('manage_free_student')); ?>" class="nav-link"><i
                                            class="fas fa-angle-right"></i>Fee Exceptions</a>
                                </li>
...
$(document).ready(function(){
    ...
    var formattedday= day.toString().padStart(2, '0');
     ...
     var currnt_date = formattedday+"/"+formattedMonth+"/"+year;

     $("#current_date_header").html(currnt_date);
...
</html><?php /**PATH C:\Users\Momtaj Husen\Desktop\Gurukul_School\resources\views/Admin_Page/Super_Admin/admin_template.blade.php ENDPATH**/ ?>