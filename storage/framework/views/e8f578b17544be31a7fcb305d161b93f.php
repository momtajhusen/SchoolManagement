    ...
    <div class="card-body" style="overflow: scroll">
      ...
      <table class="table table-bordered" id="attendance-table">
        <thead>
          <tr class="th-day">
            <th scope="col">No.</th>
            <th scope="col" style='width: 250px;' class='d-flex'>Teachers Name</th>
...
<?php echo $__env->make('Admin_Page/Super_Admin/admin_template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u569470620/domains/mustlearn.in/public_html/Gurukul_School/resources/views/Admin_Page/Super_Admin/layouts/Teachers_Attendance/teachers-attendance-report.blade.php ENDPATH**/ ?>