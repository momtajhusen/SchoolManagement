                                ...
                                <form class="added-teacher-subject-form">
                                    ...
                                    <div class="col-12-xxxl col-lg-3 col-12 form-group">
                                        ...
                                        <div class="col-12-xxxl col-lg-3 col-12 form-group">
                                            ...
                                            <select name="class" required class="select2 class-select search-class-subject"  style="height:50px;width:100%; padding:10px;background:#f8f8f8; outline: none; border:none;">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('Admin_Page/Super_Admin/admin_template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u569470620/domains/mustlearn.in/public_html/Gurukul_School/resources/views/Admin_Page/Super_Admin/layouts/Teachers/teacher-subjects.blade.php ENDPATH**/ ?>