...
<?php $__env->startSection('script'); ?>
    ...
    <script src="<?php echo e(asset('../admin_lang/Transport/ajax-get-all-vehicle-root.js')); ?>?v=<?php echo e(time()); ?>"></script>
            ...
            <div class="card-body">
                ...
                <form class="student-added-form" enctype="multipart/form-data">
                    <div class="row">
                        ...
                        <div class="col-xl-3 col-lg-6 col-12 form-group">
                            <label>Gender *</label>
                            <select name="student_gender" class="select2">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('Super_Admin/admin_template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Momtaj Husen\Desktop\School Accounting\resources\views/Super_Admin/layouts/Student_Management/add-students.blade.php ENDPATH**/ ?>