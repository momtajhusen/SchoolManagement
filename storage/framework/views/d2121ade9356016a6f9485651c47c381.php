                    ...
                    <div class="heading-layout1">
                        ...
                        <div class="row">
                            ...
                            <div class="col-2-xxxl col-xl-2 col-lg-2 col-12 form-group" >
                                    <br>
                                    <button class="fw-btn-fill btn-gradient-yellow btn search-btn" visitorbtn="btn" btnName="Generate" style="height:50px">GENERATE</button>
                                </div>
                        </div>
                        </div>
                        ...
                        <div class="d-flex justifuy-content-center align-items-center">
                              ...
                              <nav class="mt-3" aria-label="Page navigation example">
                                <ul class="pagination">
                                  ...
                                  <div class="d-flex card-pagnation">
                            ...
                            <button class="btn-fill-lg bg-dark m-2 btn-hover-bluedark" visitorbtn="btn" btnName="Download Id Image" id="btn-download" style="width:250px;">
                                
                                <span>Download Id Image</span>
                                <span id="processing-percentage"></span>
                            </button>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('Admin_Page/Super_Admin/admin_template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u569470620/domains/scriptqube.com/public_html/Schools_Projects/Gurukul_School/resources/views/Admin_Page/Super_Admin/layouts/Student_Management/generate_id_card.blade.php ENDPATH**/ ?>