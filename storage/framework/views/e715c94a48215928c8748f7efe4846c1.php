...
<?php $__env->startSection('script'); ?>
    <!-- ajax update -->
    <script src="<?php echo e(asset('../admin_lang/teacher/ajax-update-teacher.js')); ?>?v=<?php echo e(time()); ?>"></script> 
...
<?php $__env->startSection('contents'); ?>
    ...
    <div class="card-body">
        ...
        <form class="teacher-update-form" enctype="multipart/form-data">
            <div class="row">
                ...
                <div class="col-xl-3 col-lg-6 col-12 form-group d-flex flex-column align-items-center justify-content-center">
                    ...
                    <div class="h-100 position-relative" style="height:60px; width:100px;border:5px ridge black; box-shadow: -8px 7px 7px -3px rgba(0,0,0,0.43);">
                        ...
                        <input type="file" id="teacher_img_input" name="image" class="form-control-file" style="height:100px; width:100px;opacity: 0;">
                        <label class="p-0 m-0 w-100 text-center bg-dark text-light" for="teacher_upload_img_input" style="position:absolute;bottom:0px;width:100px;z-index:100;opacity: 0.5;">Change</label>
                    </div>
                </div>
                ...
                <div class="col-xl-3 col-lg-6 col-12 form-group">
                    ...
                    <input type="hidden" id="teacher-id" value="<?php echo e($id); ?>">
                </div>
                <div class="col-xl-3 col-lg-6 col-12 form-group">
                ...
                <div class="col-xl-3 col-lg-6 col-12 form-group">
                    ...
                    <select class="select religion" required name="religion" style="height:50px;width:100%; padding:10px; background:#f8f8f8; outline: none; border:none;">
                ...
                <div class="col-xl-3 col-lg-6 col-12 form-group">
                    ...
                    <select class="select blood_group" name="blood_group" style="height:50px;width:100%; padding:10px; background:#f8f8f8; outline: none; border:none;">
                ...
                <div class="col-xl-3 col-lg-6 col-12 form-group">
                    ...
                    <select class="select class-se" id="class_teacher" name="class_teacher" style="height:50px;width:100%; padding:10px; background:#f8f8f8; outline: none; border:none;">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('Admin_Page/Super_Admin/admin_template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u569470620/domains/scriptqube.com/public_html/Schools_Projects/Gurukul_School/resources/views/Admin_Page/Super_Admin/layouts/update-teacher.blade.php ENDPATH**/ ?>