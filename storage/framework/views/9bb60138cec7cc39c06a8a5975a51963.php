                            ...
                            <form class="student-update-form" enctype="multipart/form-data">
                                <div class="row">
                                    ...
                                    <div class="col-lg-3 col-12 form-group">
                                        ...
                                        <input class="class-select" readonly name="class" value="" style="height:50px;width:100%; padding:10px;">
...
<?php echo $__env->make('Super_Admin/admin_template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Momtaj Husen\Desktop\School Accounting\resources\views/Super_Admin/layouts/Student_Management/update_student_details.blade.php ENDPATH**/ ?>