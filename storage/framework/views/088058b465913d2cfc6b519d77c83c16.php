                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-3 col-lg-6 col-12 form-group d-flex flex-column align-items-center justify-content-center">
                                        ...
                                        <div class="h-100 position-relative" style="height:60px; width:100px;border:5px ridge black; box-shadow: -8px 7px 7px -3px rgba(0,0,0,0.43);">
                                            ...
                                            <label class="p-0 m-0 w-100 text-center bg-dark text-light" for="student_img_input" style="position:absolute;bottom:0px;width:100px;z-index:100;opacity: 0.5;">UPLOAD</label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-3 col-12 form-group">
                                        ...
                                        <input class="class-select class-paymode" readonly name="class" value="" style="height:50px;width:100%; padding:10px;">
                                    ...
                                    <div class="col-lg-3 col-12 form-group">
                                        ...
                                        <select name="hostel_outi" required class="select hostel_outi paymode" id="hostel_outi" style="height:50px;width:100%; padding:10px;">
                                    ...
                                    <div class="col-xl-3 col-lg-6 col-12 form-group" id="transport">
                                        ...
                                        <select name="transport_use" class="select paymode" id="transport_use" style="height:50px;width:100%; padding:10px;">
                                            <option value="">Choose Option</option>
                                    ...
                                    <div class="col-xl-3 col-lg-6 col-12 form-group" id="transport_root">
                                        ...
                                        <select name="vehicle_root" class="select paymode" id="root_select" style="height:50px;width:100%; padding:10px;">
                                        </select>
                                    </div>

                                    <div class="col-xl-3 col-lg-6 col-12 form-group" id="tuitiont">
                                        <label>Tuition *</label>
                                        <select name="tuitiont_use" required class="select paymode" id="tuitiont_use" style="height:50px;width:100%; padding:10px;">
                                            <option value="">Choose Option</option>
                                            <option value="Yes">Yes</option>
                                            <option value="No">No</option>
                                        </select>
                                        ...
                                        <div class="tab-content">
                                            <div class="tab-pane fade show active" id="tab8" role="tabpanel">
                                                ...
                                                <div class="table-responsive">
                                                 ...
                                                 <div class="pagnation-box mt-3"></div>
                                            </div>
...
<?php echo $__env->make('Super_Admin/admin_template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u569470620/domains/mustlearn.in/public_html/Sunrise_School/resources/views/Super_Admin/layouts/Student_Management/update_student_details.blade.php ENDPATH**/ ?>