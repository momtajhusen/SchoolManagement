                        ...
                        <form class="exam-timetable-form">
                            <div class="row">
                                ...
                                <div class="col-12-xxxl col-lg-3 col-12 form-group">
                                    ...
                                    <input type="text" maxlength="10" required name="exam_date" placeholder="yyyy-mm-dd" class="form-control admission_date nepali-datepicker">
                ...
                <div class="col-8-xxxl col-12">
                        <div class="card height-auto">
                            <div class="card-body">
                                ...
                                <form class="mg-b-20 timetable-search-form">
                                    <div class="row gutters-8">
                                        <div class="col-lg-5 col-12 form-group">
                                            <select name="exam" required class="select2 select-process-term" id="timetable-list-exam" style="height:50px;width:100%; padding:10px;background:#f8f8f8; outline: none; border:none;">
...
<?php echo $__env->make('Admin_Page/Super_Admin/admin_template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u569470620/domains/scriptqube.com/public_html/Schools_Projects/Gurukul_School/resources/views/Admin_Page/Super_Admin/layouts/Exam_Management/exam-timetable.blade.php ENDPATH**/ ?>