...
<?php $__env->startSection('script'); ?>
    ...
    <!-- ajax-student-fee.js -->
    <script src="<?php echo e(asset('../admin_lang/parents/ajax-student-fee.js')); ?>?v=<?php echo e(time()); ?>"></script> 

    <!-- ajax parent wallet -->
    <script src="<?php echo e(asset('../admin_lang/parents/ajax-parent-wallet.js')); ?>?v=<?php echo e(time()); ?>"></script> 

    <!-- ajax deal fee save -->
    <script src="<?php echo e(asset('../admin_lang/parents/ajax-deal-fee-set.js')); ?>?v=<?php echo e(time()); ?>"></script> 
...
<?php echo $__env->make('Admin_Page/Super_Admin/admin_template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u569470620/domains/scriptqube.com/public_html/Schools_Projects/Gurukul_School/resources/views/Admin_Page/Super_Admin/layouts/Parents/parent-profile.blade.php ENDPATH**/ ?>