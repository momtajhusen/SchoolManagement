...
<?php $__env->startSection('script'); ?>
    ...
    <script src="<?php echo e(asset('../admin_lang/Exam_Management/ajax_print_marksheet.js')); ?>?v=<?php echo e(time()); ?>"></script> 
                ...
                <form class="mg-b-20 marksheet-form">
                    <div class="row gutters-8">
                        ...
                        <div class="col-lg-3 col-12 form-group d-flex align-items-end">
                            <button type="submit" class="fw-btn-fill btn-gradient-yellow py-2">Generate Marksheets</button>
                        </div>
                    </div>
                </form>
...
<?php echo $__env->make('Admin_Page/Super_Admin/admin_template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u569470620/domains/mustlearn.in/public_html/Gurukul_School/resources/views/Admin_Page/Super_Admin/layouts/Exam_Management/print-marksheets.blade.php ENDPATH**/ ?>