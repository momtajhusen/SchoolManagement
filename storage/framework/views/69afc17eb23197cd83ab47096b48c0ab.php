    ...
    <div class="row">
        <div class="col-8-xxxl col-12">
            <div class="card height-auto">
                <div class="card-body">
                    <div class="heading-layout1 d-flex justify-content-between align-items-center">
                        ...
                        <div class="row gutters-8">
                            ...
                            <div class="col-1-xxxl col-xl-2 col-lg-3 col-12 form-group py-2">
                        ...
                        <div class="table-responsive">
                            <table class="table display data-table text-nowrap">
                                ...
                                <tbody class="studnt-table">
                                    ...
                                    <th colspan="7" class="border"><center>Please Search Student</center></th>
                    ...
                    <div class="col-12 form-group mg-t-8 d-flex justify-content-between">
                            <div class="message-btn-box d-none">
                            ...
                            <div class="message-btn-box d-none">
                                <button  class="btn-fill-lg bg-dark  btn-hover-bluedark d-flex message-send-btn">
...
<?php echo $__env->make('Super_Admin/admin_template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u569470620/domains/mustlearn.in/public_html/Sunrise_School/resources/views/Super_Admin/layouts/Account_management/dues-list.blade.php ENDPATH**/ ?>