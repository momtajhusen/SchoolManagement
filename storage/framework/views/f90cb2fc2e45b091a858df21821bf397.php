...
<!-- Logout ajax -->
<script src="<?php echo e(asset('../admin_lang/UserLogin/ajax-logout.js')); ?>?v=<?php echo e(time()); ?>"></script>
    ...
    <div id="wrapper" class="wrapper bg-ash">
       <!-- Header Menu Area Start Here -->
                ...
                <ul class="navbar-nav">
                    <li class="navbar-item dropdown header-admin">
                        <a class="navbar-nav-link dropdown-toggle" href="#" role="button" data-toggle="dropdown"
                            ...
                            <div class="admin-img">
                                <img id="profile_image" src="<?php echo e(asset('../admin_template_assets/img/figure/admin.jpg')); ?>" style="width:40px;" alt="Admin">
                            </div>
                        </a>
                        <div class="dropdown-menu dropdown-menu-right">
                            ...
                            <div class="item-content">
                                <ul class="settings-list">
                                    ...
                                    <li class="teacher-logout-btn"><a href="#"><i class="flaticon-turn-off"></i>Log Out</a></li>
                                </ul>
                            </div>
                        </div>
                    </li>
        ...
        <div class="dashboard-page-one">
               ...
               <div class="mobile-sidebar-header d-md-none">
                ...
                <div class="sidebar-menu-content" style="height:100vh;">
                    <ul class="nav nav-sidebar-menu sidebar-toggle-view">
                        ...
                        <li class="nav-item <?php echo e(request()->routeIs(['teacher-dashboard']) ? 'active-select-menu' : ''); ?>">
                            <a href="<?php echo e(route('teacher-dashboard')); ?>" class="nav-link d-flex align-items-center">
                                <span class="material-symbols-outlined pr-3" style="font-size:25px;">dashboard</span>
                                <span>Dashboard</span>
                            </a>
                        </li>

                        <li class="nav-item <?php echo e(request()->routeIs(['exam-marks-entry']) ? 'active-select-menu' : ''); ?>">
                            <a href="<?php echo e(route('exam-marks-entry')); ?>" class="nav-link d-flex align-items-center">
                                <span class="material-symbols-outlined pr-3" style="font-size:25px;">edit_note</span>
                                <span>Entry Exam Marks</span>
                            </a>
                        </li>
            ...
            <div class="dashboard-content-one p-3">
...
</html><?php /**PATH /home/u569470620/domains/mustlearn.in/public_html/Gurukul_School/resources/views/Admin_Page/Teacher_Account/teacher_template.blade.php ENDPATH**/ ?>