        ...
        <div class="d-none col-4-xxxl col-12">
            <div class="card height-auto">
                <div class="card-body">
                    ...
                    <div class="card height-auto  student_details_cars">
                            ...
                            <form class="student-update-form" enctype="multipart/form-data">
                                <div class="row">
                                    ...
                                    <div class="col-xl-3 col-lg-6 col-12 form-group" id="tuitiont">
                                        <label>Tuition *</label>
                                        <select name="tuitiont_use" required class="select" id="tuitiont_use" style="height:50px;width:100%; padding:10px;background:#f8f8f8; outline: none; border:none;">
                                            <option value="">Choose Option</option>
                                            <option value="Yes">Yes</option>
                                            <option value="No">No</option>
                                        </select>
...
<?php echo $__env->make('Admin_Page/Super_Admin/admin_template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Momtaj Husen\Desktop\Gurukul_School\resources\views/Admin_Page/Super_Admin/layouts/Student_Management/update_student_details.blade.php ENDPATH**/ ?>