...
<?php $__env->startSection('script'); ?>
    ...
    <!-- ajax school Details  -->
    <script src="<?php echo e(asset('../admin_lang/school_details/ajax_school_details.js')); ?>?v=<?php echo e(time()); ?>"></script> 

    <!-- ajax date setting  -->
    <script src="<?php echo e(asset('../admin_lang/school_details/ajax_date_setting.js')); ?>?v=<?php echo e(time()); ?>"></script> 
 
    <!-- script image Crope preview img  -->
    <script src="<?php echo e(asset('../admin_lang/common/ImageCrope/School-Details-Crop.js')); ?>?v=<?php echo e(time()); ?>"></script> 
...
<?php $__env->startSection('contents'); ?>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-3 col-lg-6 col-12 form-group d-flex flex-column align-items-center justify-content-center">
                        ...
                        <div class="h-100 position-relative" style="height:60px; width:100px;border:5px ridge black; box-shadow: -8px 7px 7px -3px rgba(0,0,0,0.43);">
                            ...
                            <label class="p-0 m-0 w-100 text-center bg-dark text-light" for="logo_img_input" style="position:absolute;bottom:0px;width:100px;z-index:100;opacity: 0.5;">UPLOAD</label>
                        </div>
                    </div>
    ...
    <!--    </div>-->
<?php $__env->stopSection(); ?>
<?php echo $__env->make('Super_Admin/admin_template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u569470620/domains/mustlearn.in/public_html/Sunrise_School/resources/views/Super_Admin/layouts/website-setting.blade.php ENDPATH**/ ?>