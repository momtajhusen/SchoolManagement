                    ...
                    <div class="d-flex flex-column align-items-center justify-content-center" style="width:80%;">
                        ...
                        <div class="w-100 d-flex">
                            <div class="w-50 form-group m-1">
                                <label class="text-light">Dis. %</label>
                                <label class="text-light ml-5">Saving</label>
                                <div class="d-flex">
                                ...
                                <input type="number" readonly value="0" id="discount" name="discount" placeholder="Discount" class="form-control" style="background-color:#ccc !important;width:60%;border-radius: 0 0 10 10px;">
                                </div>
                            </div>
                            <div class="w-50 form-group m-1">
                        ...
                        <div class="w-100 form-group m-1">
                            ...
                            <input type="text" value="07/06/2080" required maxlength="10" id="payment_date" name="payment_date" placeholder="dd/mm/yyyy" class="form-control">
                        </div>
    ...
    <div class="card-body px-3 px-md-5">
            <div class="item-title">
                ...
                <div class="row px-4">
                    <div class="col-12 col-md-3 order-2 order-md-1">
                        ...
                        <div class="d-flex">
                               <button id="printInvoice" class="d-flex align-items-center" style="font-size:10px; border:none; outline:none; cursor:pointer;">invoice  
                              ...
                              <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu p-3" aria-labelledby="dropdownMenuButton" style="width:50px !important; outline:none;">
                                        ...
                                        <label for="checkbox8"> Kar</label><br>
            ...
            <div>
                <div class="w-100" style="overflow-x:scroll;">
                    ...
                    <div class="w-100" style="overflow: overlay;">
...
<?php echo $__env->make('Admin_Page/Super_Admin/admin_template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u569470620/domains/mustlearn.in/public_html/Developer/resources/views/Admin_Page/Super_Admin/layouts/Account_management/fee-payment.blade.php ENDPATH**/ ?>