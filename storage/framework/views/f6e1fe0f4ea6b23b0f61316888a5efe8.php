            ...
            <div class="row gutters-8">
                <div class="col-3-xxxl col-xl-3 col-lg-3 col-12 form-group">
                    <select class="select2 parents-search-select" name="student_blood_group">
                        ...
                        <option value="mother_mobile">Mother Mobile</option>
                    </select>
                </div>
                <div class="col-4-xxxl col-xl-7 col-lg-3 col-12 form-group">
                    <input type="text" value="" maxlength="30" placeholder="Enter Parents Name ..." class="form-control parents-input-search">
                </div>

                <div class="col-1-xxxl col-xl-2 col-lg-3 col-12 form-group">
                    <div class="fw-btn-fill btn-gradient-yellow text-center w-100 search-parents">SEARCH</div>
                </div>
...
<?php echo $__env->make('Super_Admin/admin_template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u569470620/domains/mustlearn.in/public_html/Sunrise_School/resources/views/Super_Admin/layouts/Student_Management/student_parents.blade.php ENDPATH**/ ?>