...
<?php $__env->startSection('contents'); ?>
   ...
   <div class="row" style="margin-top: 55px;">
      <div class="col-12 col-md-4 mb-3">
        <div class="px-4 pt-2" style="height:300px;width:100%; border-radius:10px; box-shadow: rgba(99, 99, 99, 0.2) 0px 2px 8px 0px;">
                <h4 class="mb-0">Details</h4>
                 ...
                 <div>
                  <span>tr_id :</span>
                  <span class="tr_id"><?php echo e($id); ?></span>
               </div>
                 <div>
                    <span>Dob :</span>
      ...
      <div class="col-12 col-md-4 mb-3">
        <div  class="px-4 pt-2" style="height:300px;width:100%;border-radius:10px; box-shadow: rgba(99, 99, 99, 0.2) 0px 2px 8px 0px;">
          <h4 class="mb-0">Salary Recive</h4>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('Admin_Page/Super_Admin/admin_template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u569470620/domains/scriptqube.com/public_html/Schools_Projects/Gurukul_School/resources/views/Admin_Page/Super_Admin/layouts/Teachers/teacher-profile.blade.php ENDPATH**/ ?>