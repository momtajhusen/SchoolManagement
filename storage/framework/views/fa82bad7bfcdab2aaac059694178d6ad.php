                ...
                <div class="sidebar-menu-content" style="height:100vh;">
                    <ul class="nav nav-sidebar-menu sidebar-toggle-view">
                        ...
                        <li class="nav-item sidebar-nav-item">
                            ...
                            <ul class="nav sub-group-menu">
                            <li class="nav-item">
                                    <a href="<?php echo e(route('account-dashboard')); ?>" class="nav-link"><i class="fas fa-angle-right"></i>
                        ...
                        <li class="nav-item sidebar-nav-item">
                            <a href="#" class="nav-link d-flex">
                                <span class="material-symbols-outlined mr-3" style="font-size:20px;color:#ff9d37">article</span>
                                <span>Exam</span>
                            </a>
                            <ul class="nav sub-group-menu">
                                <li class="nav-item">
                                    <a href="#" class="nav-link">
                                        <i class="fas fa-angle-right"></i>Create Exam
                                    </a>
                                    <a href="#" class="nav-link">
                                        <i class="fas fa-angle-right"></i>Print Admit Card
                                    </a>
                                    <a href="#" class="nav-link">
                                        <i class="fas fa-angle-right"></i>Progress Report
                                    </a>
                                </li>                  
                            </ul>
                        </li>
...
</html><?php /**PATH /home/u569470620/domains/mustlearn.in/public_html/Sunrise_School/resources/views/Super_Admin/admin_template.blade.php ENDPATH**/ ?>