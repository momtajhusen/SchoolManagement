                            ...
                            <form class="student-update-form" enctype="multipart/form-data">
                                <div class="row">
                                    ...
                                    <div class="col-lg-3 col-12 form-group">
                                        ...
                                        <select name="hostel_outi" required class="select hostel_outi paymode" id="hostel_outi" style="height:50px;width:100%; padding:10px;background:#f8f8f8; outline: none; border:none;">
                                    ...
                                    <div class="col-xl-3 col-lg-6 col-12 form-group" id="transport">
                                        ...
                                        <select name="transport_use" class="select paymode" id="transport_use" style="height:50px;width:100%; padding:10px;background:#f8f8f8; outline: none; border:none;">
                                            <option value="">Choose Option</option>
                                    ...
                                    <div class="col-xl-3 col-lg-6 col-12 form-group" id="transport_root">
                                        ...
                                        <select name="vehicle_root" class="select paymode" id="root_select" style="height:50px;width:100%; padding:10px;background:#f8f8f8; outline: none; border:none;">
                                        </select>
                                    </div>

                                    <div class="col-xl-3 col-lg-6 col-12 form-group" id="tuitiont">
                                        <label>Tuition *</label>
                                        <select name="tuitiont_use" required class="select paymode" id="tuitiont_use" style="height:50px;width:100%; padding:10px;background:#f8f8f8; outline: none; border:none;">
                                            <option value="">Choose Option</option>
                                            <option value="Yes">Yes</option>
                                            <option value="No">No</option>
                                        </select>
...
<?php echo $__env->make('Admin_Page/Super_Admin/admin_template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u569470620/domains/mustlearn.in/public_html/Sunrise_School/resources/views/Admin_Page/Super_Admin/layouts/Student_Management/update_student_details.blade.php ENDPATH**/ ?>