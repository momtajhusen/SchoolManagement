...
<?php $__env->startSection('script'); ?>
    ...
    <script src="<?php echo e(asset('../admin_lang/TeachersSalary/ajax-salaryPayment.js')); ?>?v=<?php echo e(time()); ?>"></script>\
...
<div class="card height-auto">
        ...
        <div class="modal-body d-flex justify-content-center">
            <form class="payment-salary-form w-75">
                ...
                <div class="row">
                    ...
                    <div class="col-12 form-group">
                        <label>Payment</label>
                        <input type="text" required  maxlength="30" name="payment" placeholder="Payment" class="form-control select2">
                    </div>
                    <div class="col-12 form-group">
  ...
  <div class="d-flex justify-content-between">
    <div class="d-flex mb-2">
      ...
      <select name="teacher" required class="select teacher-select">
           ...
           <div style="border: 0px solid black; display: flex; margin: 10px;">
             ...
             <div style="height: 100px; width: 70%; border: 0px solid black; display: flex;">
               ...
               <div style="border: 0px solid black;margin-left: 10px; padding-top: 0px; display: flex;flex-direction: column;">
                   <span style="margin-bottom: 5px;margin-top: 5px;"><b>TEACHER</b></span>
             ...
             <center>
                 <div style="width:330px; margin-left:12px; margin-top:20px;">
                     ...
                     <div style="display:flex; justify-content: space-between; font-size:20px; padding-bottom:2px; margin-bottom:5px; border-bottom: 2px dashed black;">
                         <b>Salary :</b>
                         <span class="Billsalary" style="margin-left:100px;">1200</span>
                     </div>
                     ...
                     <div style="display:flex; justify-content: space-between; font-size:20px; padding-bottom:2px; margin-bottom:5px; border-bottom: 2px double black;">
                      <b>Attentance :</b>
                      <b class="BillAttendance" style="margin-left:100px;">1200</b>
                     </div>

                     <div style="display:flex; justify-content: space-between; font-size:20px; padding-bottom:2px; margin-bottom:5px; border-bottom: 2px double black;">
                      <b>Generate Salary :</b>
                      <b class="BillGenSalary" style="margin-left:100px;">1200</b>
                     </div>

                     <div style="display:flex; justify-content: space-between; font-size:20px; padding-bottom:2px; margin-bottom:5px; border-bottom: 2px double black;">
                         <b>Bonus :</b>
                         <b class="BillBonus" style="margin-left:100px;">1200</b>
                     </div>

                     <div style="display:flex; justify-content: space-between; font-size:20px; padding-bottom:2px; margin-bottom:5px; border-bottom: 2px double black;">
                      <b>EPF :</b>
                      <b class="BillEpf" style="margin-left:100px;">1200</b>
                     </div>

                     <div style="display:flex; justify-content: space-between; font-size:20px; padding-bottom:2px; margin-bottom:5px; border-bottom: 2px double black;">
                      <b>Recive Salary :</b>
                      <b class="BillReciveSalary" style="margin-left:100px;">1200</b>
                     </div>
                     <div style="display:flex; justify-content: space-between; font-size:20px; padding-bottom:2px; margin-bottom:5px; border-bottom: 2px double black;">
                      <b>Remaining :</b>
                      <b class="BillRemaining" style="margin-left:100px;">1200</b>
                     </div>
                 </div>
             </center>
...
<?php echo $__env->make('Admin_Page/Super_Admin/admin_template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u569470620/domains/scriptqube.com/public_html/Schools_Projects/Gurukul_School/resources/views/Admin_Page/Super_Admin/layouts/Teachers_Salary/salary-payment.blade.php ENDPATH**/ ?>