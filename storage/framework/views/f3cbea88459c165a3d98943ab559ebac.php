    ...
    <div class="card-body">
            ...
            <div class="row gutters-8">
                ...
                <div class="col-12 col-md-10 form-group">
                    <input type="number" value="<?php echo e(isset($id) ? $id : ''); ?>" id="parent_id" maxlength="30" placeholder="Enter Parent id" class="form-control parents-input-search py-4" style="height:98%;background:#f0f1f3;">
                </div>
...
<?php echo $__env->make('Admin_Page/Super_Admin/admin_template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u569470620/domains/scriptqube.com/public_html/Schools_Projects/Gurukul_School/resources/views/Admin_Page/Super_Admin/layouts/Student_Management/manage_free_student.blade.php ENDPATH**/ ?>