    ...
    <div class="card-body">
        ...
        <form class="driver-added-form" enctype="multipart/form-data">
            <div class="row">
                ...
                <div class="col-12 form-group mg-t-8" style="z-index: 100">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('Super_Admin/admin_template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Momtaj Husen\Desktop\School Accounting\resources\views/Super_Admin/layouts/Transport/add-driver.blade.php ENDPATH**/ ?>