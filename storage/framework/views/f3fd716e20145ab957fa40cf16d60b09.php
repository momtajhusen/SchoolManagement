                                ...
                                <div class="earning-report">
                                    <div class="item-content w-100 d-flex justify-content-between">
                                        <div>
                                            ...
                                            <div class="d-flex">
                                                <span class="mr-2">₹ </span><h3 class="p-0 m-0" id="collection-amount" style="font-width:bold;">0</h3>
                                            </div>
                                        </div>
                                        <div>
                                            <span class="m-0" style="color: #ab9fa8;">Total History</span>
                                            <div class="d-flex">
                                                 <h3 class="p-0 m-0" id="total-history" style="font-width:bold;">0</h3>
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('Admin_Page/Super_Admin/admin_template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u569470620/domains/mustlearn.in/public_html/Sunrise_School/resources/views/Admin_Page/Super_Admin/layouts/SuperAdminDashboard.blade.php ENDPATH**/ ?>