                    ...
                    <div class="d-flex flex-column align-items-center justify-content-center" style="width:80%;">
                        ...
                        <div class="w-100 d-flex">
                            <div class="w-100 form-group m-1">
                                ...
                                <label class="text-light" style="margin-left: 25%;">Saving</label>
                                <div class="d-flex">
                ...
                <div class="heading-layout1 d-flex justify-content-between">
                    ...
                    <div class="row d-none" id="student_id_row">
                       <div class="col-xl-10 col-lg-10 col-12 form-group">
                        ...
                        <div class="col-2-xxxl col-xl-2 col-lg-2 col-12 form-group" >
                            <br>
                            <button class="fw-btn-fill btn-gradient-yellow btn search-btn form-group" style="height:50px">SEARCH</button>
                        </div>
                    </div>
                        ...
                        <div style="width: 100%; height: 100%; border : 2px solid black; overflow: hidden;box-sizing:-box;position: relative;">
                            ...
                            <div style="border: 0px solid black; display: flex;">
                                ...
                                <div style="border: 0px solid black;margin-left: 10px; padding-top: 0px; display: flex;flex-direction: column;">
                                    ...
                                    <div style="margin-bottom: 5px;"><b>Roll:</b> <span class="st_roll" id="st_roll">0</span></div>
                                </div>
                                </div>
                                ...
                                <div style="margin-bottom: 5px;"><b>Date:</b> <span class="bill-date" id="bill-date"></span></div>
                                <div style="margin-bottom: 5px;"><b>Bill No: </b><span class="bill_no" id="bill_no">0</span></div>
...
<?php echo $__env->make('Admin_Page/Super_Admin/admin_template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u569470620/domains/mustlearn.in/public_html/Gurukul_School/resources/views/Admin_Page/Super_Admin/layouts/Account_management/fee-payment.blade.php ENDPATH**/ ?>