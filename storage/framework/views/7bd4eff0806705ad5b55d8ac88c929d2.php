                ...
                <ul class="navbar-nav">
                    <li class="navbar-item dropdown header-admin">
                        <a class="navbar-nav-link dropdown-toggle" href="#" role="button" data-toggle="dropdown"
                            ...
                            <div class="admin-img">
                                <img id="parent_img" src="<?php echo e(asset('../admin_template_assets/img/figure/admin.jpg')); ?>" style="width:40px;" alt="Admin">
                            </div>
                        </a>
               ...
               <div class="mobile-sidebar-header d-md-none">
                ...
                <div class="sidebar-menu-content" style="height:100vh;">
                    <ul class="nav nav-sidebar-menu sidebar-toggle-view">
                        ...
                        <li class="nav-item <?php echo e(request()->routeIs(['parent-dashboard']) ? 'active-select-menu' : ''); ?>">
                            <a href="<?php echo e(route('parent-dashboard')); ?>" class="nav-link d-flex align-items-center">
...
</html><?php /**PATH C:\Users\Momtaj Husen\Desktop\School Accounting\resources\views/Parent_Account/parent_template.blade.php ENDPATH**/ ?>