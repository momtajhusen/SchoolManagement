...
class TeachersAttendanceController extends Controller
{
    ...
    public function getTeacherAttendancePeriod(Request $request)
    {
        try {
            ...
            $year = $request->year;
            $date = LaravelNepaliDate::from($request->input("admission_date"))->toEnglishDate();
            ...
            if (count($TeachersPeriods) != 0) {
                ...
                foreach ($TeachersPeriods as $teacher) {
                    ...
                    if ($TeacherData) {
                        ...
                        Log::info("Teacher with id {$teacher->tch_id} not found or not admitted.");
                    }
                }
    ...
    public function SaveTeachersAttendance(Request $request)
    {
        try {
               // Validate the request data
                ...
                $todayDate = LaravelNepaliDate::from($request->input('todayDate'))->toEnglishDate();
