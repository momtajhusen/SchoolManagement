...
class TeacherController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $teacher->dob  = LaravelNepaliDate::from($request->input("dob"))->toEnglishDate();
            ...
            $teacher->joining_date  = LaravelNepaliDate::from($request->input("joining_date"))->toEnglishDate();
