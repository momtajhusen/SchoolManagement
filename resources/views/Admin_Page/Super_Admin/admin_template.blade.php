...
<head>
    ...
    <script src="{{ asset('admin_lang/HelperScript/ReuseScript.js')}}?v={{ time() }}" defer></script>
    ...
    {{-- student-img-hover-preview.js --}}
    <script src="{{ asset('admin_lang/common/hover-img-preview.js')}}?v={{ time() }}"></script>

    {{-- student-img-hover-preview.js --}}
    <script src="{{ asset('admin_lang/HelperScript/CheckInternetConnection.js')}}?v={{ time() }}"></script>
    
    {{-- student-img-hover-preview.js --}}
    <script src="{{ asset('admin_lang/HelperScript/removeTrailingZeros.js')}}?v={{ time() }}"></script>
    ...
    <!-- NetworkAlert css -->
    <link rel="stylesheet"  href="{{ asset('../admin_template_assets/NetworkAlert.css')}}">
...
<body class="position-relative">
            ...
            <div class="navbar navbar-expand-md header-menu-one w-100" style="position: fixed; z-index:100;">
                <div class="nav-bar-header-one p-0">
                    ...
                    <div class="d-flex flex-column" style="line-height: 18px">
                            ...
                            <span style="font-size: 10px;color: #bdbdbd">Momtaj Raza Bijay</span>
                    </div>
                    </div>
                </div>
                        ...
                        <li class="navbar-item dropdown header-admin">
                            <a class="navbar-nav-link dropdown-toggle" href="#" role="button" data-toggle="dropdown"
                                ...
                                <div class="admin-title">
                                    <h5 class="item-title" style="color: #e0dede">Admin</h5>
                                    <span style="color: #e0dede">{{ session('user_name') }}</span>
                                </div>
                                <div class="admin-img">
                ...
                <div class="mobile-sidebar-header d-md-none">
                    ...
                    <div class="sidebar-menu-content" style="height: 100vh; overflow-y: scroll;padding-bottom:100px;">
                        <ul class="nav nav-sidebar-menu sidebar-toggle-view">
                            ...
                            <li class="nav-item sidebar-nav-item" id="old-report-menu">
                                ...
                                <ul class="nav sub-group-menu">
                                    <li class="nav-item">
                                        <a href="{{route('financial-overview')}}" class="nav-link {{ Request::is('admin/financial-overview') ? 'active-select-menu' : '' }}">
                                            <i class="fas fa-angle-right"></i>
                                            <span class="menu-name">Financial Overview</span>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="{{route('fee-collection-reports')}}" class="nav-link {{ Request::is('admin/fee-collection-reports') ? 'active-select-menu' : '' }}">
                                            <i class="fas fa-angle-right"></i>
                                            <span class="menu-name">Fee Collections</span>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="{{route('salary-report')}}" class="nav-link {{ Request::is('admin/salary-report') ? 'active-select-menu' : '' }}">
                                        <i class="fas fa-angle-right"></i>
                                        <span class="menu-name">Salary</span>
                                    </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="{{route('fee-ledger')}}" class="nav-link {{ Request::is('admin/fee-ledger') ? 'active-select-menu' : '' }}">
                                        <i class="fas fa-angle-right"></i>
                                        <span class="menu-name">Fee Ladger</span>
                                    </a>
                                    </li>
                                    {{-- <li class="nav-item">
                                    ...
                                    <li class="nav-item">
                                        <a href="{{route('expense-reports')}}"  class="nav-link {{ Request::is('admin/expense-reports') ? 'active-select-menu' : '' }}">
                                            <i class="fas fa-angle-right"></i>
                            ...
                            <li class="nav-item sidebar-nav-item d-none" id="new-report-menu">
                                <a href="#" class="nav-link d-flex">
                                    <span class="material-symbols-outlined mr-3" style="font-size:20px;color:#ff9d37">pie_chart</span>
                                    <span class="menu-name">Finance Analysis</span>
                                </a>
                                <ul class="nav sub-group-menu">
                                    <li class="nav-item">
                                        <a href="{{route('new-financial-overview')}}" class="nav-link {{ Request::is('admin/new-financial-overview') ? 'active-select-menu' : '' }}">
                                            <i class="fas fa-angle-right"></i>
                                            <span class="menu-name">Financial Overview</span>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="{{route('new-fee-collection-reports')}}" class="nav-link {{ Request::is('admin/new-fee-collection-reports') ? 'active-select-menu' : '' }}">
                                            <i class="fas fa-angle-right"></i>
                                            <span class="menu-name">Fee Collections</span>
                                        </a>
                                    </li>
                            ...
                            <li class="nav-item sidebar-nav-item" id="old-account-menu">
                                ...
                                {{-- <li class="nav-item">
                                    ...
                                    <li class="nav-item d-none">
                                        <a href="{{route('fee-payment')}}" class="nav-link {{ Request::is('admin/fee-payment') ? 'active-select-menu' : '' }}">
                                        <i class="fas fa-angle-right"></i>
                                    ...
                                    <li class="nav-item">
                                        <a href="{{route('dues-list')}}" class="nav-link {{ Request::is('admin/dues-list') ? 'active-select-menu' : '' }}">
                                        <i class="fas fa-angle-right"></i>
                                    ...
                                    <li class="nav-item">
                                        <a href="{{route('add-expenses')}}" class="nav-link {{ Request::is('admin/add-expenses') ? 'active-select-menu' : '' }}">
                                            <i class="fas fa-angle-right"></i>
                                            <span class="menu-name">Add Expenses</span>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="{{route('manage-stracture')}}" class="nav-link {{ Request::is('admin/manage-feestracture') ? 'active-select-menu' : '' }}">
                                        <i class="fas fa-angle-right"></i>
                                        <span class="menu-name">Fee Structure</span>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="{{route('manage_free_student')}}" class="nav-link {{ Request::is('admin/manage-free-student') ? 'active-select-menu' : '' }}">
                                            <i class="fas fa-angle-right"></i>
                            ...
                            <li class="nav-item sidebar-nav-item d-none" id="new-account-menu">
                                ...
                                <ul class="nav sub-group-menu">
                                    <li class="nav-item">
                                        <a href="{{route('student-fee-payment')}}" class="nav-link {{ Request::is('admin/student-fee-payment') ? 'active-select-menu' : '' }}">
                                        <i class="fas fa-angle-right"></i>
                                        <span class="menu-name">Student Fee Payment</span>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="{{route('student-deus-fee-list')}}" class="nav-link {{ Request::is('admin/student-deus-fee-list') ? 'active-select-menu' : '' }}">
                                        <i class="fas fa-angle-right"></i>
                                    ...
                                    <li class="nav-item">
                                        <a href="{{route('add-expenses')}}" class="nav-link {{ Request::is('admin/manage-free-student') ? 'active-select-menu' : '' }}">
                                            <i class="fas fa-angle-right"></i>
                            ...
                            <li class="nav-item sidebar-nav-item">
                                ...
                                <ul class="nav sub-group-menu">
                                    <li class="nav-item">
                                        <a href="{{route('salary-payment')}}" class="nav-link {{ Request::is('admin/teacher-payment') ? 'active-select-menu' : '' }}">
                                            <i class="fas fa-angle-right"></i>
                                            <span class="menu-name">Salary Payment</span>
                                        </a>
                                    </li>
                                    <li class="nav-item deve-use">
                                        <a href="{{route('salary-payment-history')}}" class="nav-link {{ Request::is('admin/salary-payment-history') ? 'active-select-menu' : '' }}">
                                            <i class="fas fa-angle-right"></i>
                                            <span class="menu-name">Salary Payment History</span>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="{{route('salary-generate')}}" class="nav-link {{ Request::is('admin/salary-generate') ? 'active-select-menu' : '' }}">
                                            <i class="fas fa-angle-right"></i>
                                            <span class="menu-name">Check Salary Generate</span>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="{{route('salary-set')}}" class="nav-link {{ Request::is('admin/salary-set') ? 'active-select-menu' : '' }}">
                                            <i class="fas fa-angle-right"></i>
                                            <span class="menu-name">Set Salary</span>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="{{route('bonus-ssf-setting')}}" class="nav-link {{ Request::is('admin/bonus-ssf-setting') ? 'active-select-menu' : '' }}">
                                            <i class="fas fa-angle-right"></i>
                                            <span class="menu-name">Bonus & SST Setting</span>
                                        </a>
                                    </li>
                                </ul>
                            </li>
                            ...
                            <li class="nav-item sidebar-nav-item">
                                ...
                                <ul class="nav sub-group-menu">
                                    <li class="nav-item">
                                        <a href="{{route('teachers-attendance')}}" class="nav-link {{ Request::is('admin/teacher-attendance') ? 'active-select-menu' : '' }}">
                                            <i class="fas fa-angle-right"></i>
                                            <span class="menu-name">Teachers Attendance</span>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="{{route('staff-attendance')}}" class="nav-link {{ Request::is('admin/staff-attendance') ? 'active-select-menu' : '' }}">
                                            <i class="fas fa-angle-right"></i>
                                            <span class="menu-name">Staff Attendance</span>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="{{route('teachers-attendance-report')}}" class="nav-link {{ Request::is('admin/teacher-attendance-report') ? 'active-select-menu' : '' }}">
                                            <i class="fas fa-angle-right"></i>
                                            <span class="menu-name">Attendance Reports</span>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="{{route('set-teachers-periods')}}" class="nav-link {{ Request::is('admin/teachers-periods') ? 'active-select-menu' : '' }}">
                                            <i class="fas fa-angle-right"></i>
                            ...
                            <li class="nav-item sidebar-nav-item">
                                ...
                                <ul class="nav sub-group-menu">
                                <li class="nav-item">
                                        <a href="{{route('add-students')}}" class="nav-link {{ Request::is('admin/students-admission') ? 'active-select-menu' : '' }}"><i
                                                class="fas fa-angle-right"></i>
                                                <span class="menu-name">Student Registration</span>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="{{route('registration-list')}}" class="nav-link {{ Request::is('admin/registration-list') ? 'active-select-menu' : '' }}"><i
                                                class="fas fa-angle-right"></i>
                                    ...
                                    <li class="nav-item">
                                        <a href="{{route('all-student')}}" class="nav-link {{ Request::is('admin/all-student') ? 'active-select-menu' : '' }}">
                                            <i class="fas fa-angle-right"></i>
                                    ...
                                    <li class="nav-item">
                                        <a href="{{route('admin_student_parents')}}" class="nav-link {{ Request::is('admin/student-parents') ? 'active-select-menu' : '' }}">
                                            <i class="fas fa-angle-right"></i>
                                    ...
                                    <li class="nav-item">
                                        <a href="{{route('student-promotion')}}" class="nav-link {{ Request::is('admin/student-promotion') ? 'active-select-menu' : '' }}"><i
                                                class="fas fa-angle-right"></i>
                                    ...
                                    <li class="nav-item">
                                        <a href="{{route('passout-student')}}" class="nav-link {{ Request::is('admin/passout-student') ? 'active-select-menu' : '' }}"><i
                                                class="fas fa-angle-right"></i>
                                    ...
                                    <li class="nav-item">
                                        <a href="{{route('kick_out')}}" class="nav-link {{ Request::is('admin/kick-out') ? 'active-select-menu' : '' }}"><i
                                                class="fas fa-angle-right"></i>
                                    ...
                                    <li class="nav-item">
                                        <a href="{{route('student-identification')}}" class="nav-link {{ Request::is('admin/student-identification') ? 'active-select-menu' : '' }}"><i
                                                class="fas fa-angle-right"></i>
                            ...
                            <li class="nav-item sidebar-nav-item deve-use">
                                ...
                                <ul class="nav sub-group-menu">
                                <li class="nav-item d-none">
                                        <a href="{{route('hostel-students')}}" class="nav-link {{ Request::is('admin/hostel-students') ? 'active-select-menu' : '' }}"><i
                                                class="fas fa-angle-right"></i>
                            ...
                            <li class="nav-item sidebar-nav-item">
                                ...
                                <ul class="nav sub-group-menu">
                                    <li class="nav-item">
                                        <a href="{{route('teacher-staff-details')}}" class="nav-link {{ Request::is('admin/teacher_staff_details') ? 'active-select-menu' : '' }}">
                                            <i class="fas fa-angle-right"></i>
                                            <span class="menu-name">Teacher/Staff Details</span>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="{{route('add-new-employee')}}" class="nav-link {{ Request::is('admin/add_new_employee') ? 'active-select-menu' : '' }}">
                                            <i class="fas fa-angle-right"></i>
                            ...
                            <li class="nav-item sidebar-nav-item">
                                ...
                                <ul class="nav sub-group-menu">
                                    ...
                                    <li class="nav-item">
                                        <a href="{{route('student-marks-entry')}}" class="nav-link {{ Request::is('admin/student-marks-entry') ? 'active-select-menu' : '' }}">
                                            <i class="fas fa-angle-right"></i>
                                    ...
                                    <li class="nav-item">
                                        <a href="{{route('tabulation-sheet')}}" class="nav-link {{ Request::is('admin/tabulation-sheet') ? 'active-select-menu' : '' }}">
                                            <i class="fas fa-angle-right"></i>
                                            <span class="menu-name">Tabulation Sheet</span>
                                        </a>
                                    </li> 
                                    <li class="nav-item">
                                        <a href="{{route('print-marksheets')}}" class="nav-link {{ Request::is('admin/print-marksheets') ? 'active-select-menu' : '' }}">
                                            <i class="fas fa-angle-right"></i>
                                    ...
                                    <li class="nav-item">
                                        <a href="{{route('print-admit-cards')}}" class="nav-link {{ Request::is('admin/print-admit-cards') ? 'active-select-menu' : '' }}">
                                            <i class="fas fa-angle-right"></i>
                                            <span class="menu-name">Print Admit Cards</span>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="{{route('exam-timetable')}}" class="nav-link {{ Request::is('admin/exam-timetable') ? 'active-select-menu' : '' }}">
                                            <i class="fas fa-angle-right"></i>
                                            <span class="menu-name">Exam Timetable</span>
                                        </a>
                                    </li>  
                                    <li class="nav-item">
                                        <a href="{{route('exam-term')}}" class="nav-link {{ Request::is('admin/exam-term') ? 'active-select-menu' : '' }}">
                                            <i class="fas fa-angle-right"></i>
                                            <span class="menu-name">Exam Term</span>
                                        </a>
                                    </li> 
                                    <li class="nav-item">
                                        <a href="{{route('exam-grade')}}" class="nav-link {{ Request::is('admin/exam-grade') ? 'active-select-menu' : '' }}">
                                            <i class="fas fa-angle-right"></i>
                            ...
                            <li class="nav-item sidebar-nav-item">
                                ...
                                <ul class="nav sub-group-menu">
                                    <li class="nav-item">
                                        <a href="{{route('sell-items')}}" class="nav-link {{ Request::is('admin/sell-items') ? 'active-select-menu' : '' }}">
                                            <i class="fas fa-angle-right"></i>
                                    ...
                                    <li class="nav-item">
                                        <a href="{{route('items-in-stock')}}" class="nav-link {{ Request::is('admin/add-items-in-stock') ? 'active-select-menu' : '' }}">
                                            <i class="fas fa-angle-right"></i>
                                            <span class="menu-name">Add Items In Stock</span>
                                        </a>
                                    </li> 
                                    <li class="nav-item">
                                        <a href="{{route('items-price')}}" class="nav-link {{ Request::is('admin/items-price') ? 'active-select-menu' : '' }}">
                                            <i class="fas fa-angle-right"></i>
                                            <span class="menu-name">Add Items & Price</span>
                                        </a>
                                    </li>  
                                    <li class="nav-item">
                                        <a href="{{route('items-category')}}" class="nav-link {{ Request::is('admin/items-category') ? 'active-select-menu' : '' }}">
                                            <i class="fas fa-angle-right"></i>
                            ...
                            <li class="nav-item sidebar-nav-item">
                                ...
                                <ul class="nav sub-group-menu">
                                    <li class="nav-item">
                                        <a href="{{route('sub_admin_list')}}" class="nav-link {{ Request::is('admin/sub_admin_list') ? 'active-select-menu' : '' }}">
                                            <i class="fas fa-angle-right"></i>
                                            <span class="menu-name">Admin List</span>
                                        </a>
                                    </li> 
                                    <li class="nav-item">
                                        <a href="{{route('add_super_admin')}}" class="nav-link {{ Request::is('admin/add_super_admin') ? 'active-select-menu' : '' }}">
                                            <i class="fas fa-angle-right"></i>
                                            <span class="menu-name">Add New SuperAdmin</span>
                                        </a>
                                    </li> 
                                    <li class="nav-item">
                                        <a href="{{route('role_permission')}}" class="nav-link {{ Request::is('admin/role_permission') ? 'active-select-menu' : '' }}">
                                            <i class="fas fa-angle-right"></i>
                            ...
                            <li class="nav-item sidebar-nav-item">
                                ...
                                <ul class="nav sub-group-menu">
                                    <li class="nav-item">
                                        <a href="{{route('add-classes')}}" class="nav-link {{ Request::is('admin/add-classes') ? 'active-select-menu' : '' }}">
                                            <i class="fas fa-angle-right"></i>
                                            <span class="menu-name">Class</span>
                                        </a>
                                    </li>  
                                    <li class="nav-item">
                                        <a href="{{route('add-subjects')}}" class="nav-link {{ Request::is('admin/add-subjects') ? 'active-select-menu' : '' }}">
                                            <i class="fas fa-angle-right"></i>
                                            <span class="menu-name">Subject</span>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="{{route('teacher-subjects')}}" class="nav-link {{ Request::is('admin/teacher-subjects') ? 'active-select-menu' : '' }}">
                                            <i class="fas fa-angle-right"></i>
                            ...
                            <li class="nav-item sidebar-nav-item">
                                ...
                                <ul class="nav sub-group-menu">
                                    <li class="nav-item">
                                        <a href="{{route('class-period')}}" class="nav-link {{ Request::is('admin/class-period') ? 'active-select-menu' : '' }}">
                                            <i class="fas fa-angle-right"></i>
                                            <span class="menu-name">Class Period</span>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="{{route('class-subject')}}" class="nav-link {{ Request::is('admin/class-timetable-subject') ? 'active-select-menu' : '' }}">
                                            <i class="fas fa-angle-right"></i>
                                            <span class="menu-name">Set Class Subject</span>
                                        </a>
                                    </li>  
                                    <li class="nav-item">
                                        <a href="{{route('print-timetable')}}"  class="nav-link {{ Request::is('admin/print-timetable') ? 'active-select-menu' : '' }}">
                                            <i class="fas fa-angle-right"></i>
                                            <span class="menu-name">Class Time Table</span>
                                            </a>
                                    </li>    
                                    <li class="nav-item">
                                        <a href="{{route('teacher-timetable')}}" class="nav-link {{ Request::is('admin/teacher-timetable') ? 'active-select-menu' : '' }}">
                                            <i class="fas fa-angle-right"></i>
                            ...
                            <li class="nav-item sidebar-nav-item">
                                ...
                                <ul class="nav sub-group-menu">
                                    ...
                                    <li class="nav-item">
                                        <a href="{{route('add-vehicle')}}" class="nav-link {{ Request::is('admin/transport/vehicle') ? 'active-select-menu' : '' }}">
                                            <i class="fas fa-angle-right"></i>
                                            <span class="menu-name">Add Vehicle</span>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="{{route('vehicle-root')}}" class="nav-link {{ Request::is('admin/transport/set-vehicle-root') ? 'active-select-menu' : '' }}">
                                            <i class="fas fa-angle-right"></i>
                                            <span class="menu-name">Set Vehicle Root</span>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="{{route('transport-student')}}" class="nav-link {{ Request::is('admin/transport/transport-student') ? 'active-select-menu' : '' }}">
                                            <i class="fas fa-angle-right"></i>
                            ...
                            <li class="nav-item sidebar-nav-item">
                                <a href="{{route('message')}}" class="nav-link d-flex {{ Request::is('admin/message') ? 'active-select-menu' : '' }}">
                            ...
                            <li class="nav-item sidebar-nav-item">
                                ...
                                <ul class="nav sub-group-menu">
                                    <li class="nav-item">
                                        <a href="{{route('school-details')}}" class="nav-link {{ Request::is('admin/school-details') ? 'active-select-menu' : '' }}">
                                            <i class="fas fa-angle-right"></i>
                            ...
                            <li class="nav-item sidebar-nav-item">
                                <a href="#" class="nav-link d-flex">
                                    <span class="material-symbols-outlined mr-3" style="font-size:20px;color:#ff9d37">speech_to_text</span>
                                    <span class="menu-name">Feedback / Complaint</span>
                                </a>
                                <ul class="nav sub-group-menu">
                                    <li class="nav-item">
                                        <a href="{{route('complaint')}}" class="nav-link {{ Request::is('admin/complaint') ? 'active-select-menu' : '' }}">
                                            <i class="fas fa-angle-right"></i>
                                            <span class="menu-name">Complaint</span>
                                        </a>
                                    </li> 
                                    <li class="nav-item">
                                        <a href="{{route('feedback')}}" class="nav-link {{ Request::is('admin/feedback') ? 'active-select-menu' : '' }}">
                                            <i class="fas fa-angle-right"></i>
    ...
    <script src="{{ asset('../admin_lang/developer/feacture-skip.js')}}?v={{ time() }}"></script>
    ...
    <script type="text/javascript">
        ...
        // Active menu 
        $(document).ready(function(){
            $(".active-select-menu").each(function() {
                $(this).parent().parent().parent().find('a').click();
            });
        });

        // Scroll Position on active-menu 
        $(document).ready(function() {
            function scrollToActiveMenu() {
                const $activeItem = $('.sidebar-menu-content .active-select-menu');
                if ($activeItem.length) {
                    const $menuContent = $('.sidebar-menu-content');
                    const itemOffsetTop = $activeItem.offset().top;
                    const itemHeight = $activeItem.outerHeight();
                    const contentHeight = $menuContent.height();
                    const scrollPosition = itemOffsetTop - (contentHeight / 2) + (itemHeight / 2);
                    $menuContent.scrollTop(scrollPosition);
                }
            }
            // Call the function to scroll on page load
            scrollToActiveMenu();
        });
    
        // Current Nepal Date on header
        $(document).ready(function(){
