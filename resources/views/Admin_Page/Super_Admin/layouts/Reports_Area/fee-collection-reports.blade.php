...
@section('contents')
              ...
              <div class="border" style="height:375px; overflow-y: scroll;">
                <table class="table table-dark table-bordered table-hover table-sm table-responsive-md sortable-table" id="payment-history-date">
                    ...
                    <tr>
                      ...
                      <th nowrap="nowrap" data-column="1">Bill No.</th>
                      <th nowrap="nowrap" data-column="2">Paid</th>
                      <th nowrap="nowrap" data-column="3">Dues</th>
                      <th nowrap="nowrap" data-column="4">Paid Month</th>
                      <th nowrap="nowrap" data-column="5">Processed By</th>
                      <th nowrap="nowrap" data-column="6">Student ID</th>
                      <th nowrap="nowrap" data-column="7">Class</th>
                      <th nowrap="nowrap" data-column="8">Students Name</th>
                      <th nowrap="nowrap" data-column="9">Parents</th>
                      <th nowrap="nowrap" data-column="10">Date</th>
                      <th nowrap="nowrap" data-column="11">Time</th>
                    </tr>
                    </thead>
  ...
  <div class="border pl-3 w-100" style="height:auto; overflow-y: scroll;">
    <b>Deposit Payment</b>
    {{-- date input  --}}
    <div class="d-flex justify-content-between align-items-center">
      <div class="row m-0">
        <div class="col-5 p-0">
          <input type="text" class="currentSatrtDate w-100 deposit-from-date dateinput" placeholder="from date">
        </div>
        <div class="col-5 p-0">
          <input type="text" class="currentDate w-100 deposit-to-date dateinput" placeholder="to date">
        </div>
        <div class="col-2 p-0">
          <button type="btn" id="depositsearchDate" class="w-100">search</button>
        </div>
      </div>
    </div>
    <table class="table table-dark table-bordered table-hover table-sm table-responsive-md sortable-table" id="hostel-deposit-table">
      <thead>
      <tr>
          <th nowrap="nowrap" data-column="0">SN.</th>
          <th nowrap="nowrap" data-column="1">Parent Name</th>
          <th nowrap="nowrap" data-column="2">Deposit Amount</th>
          <th nowrap="nowrap" data-column="3">Deposit For</th>
          <th nowrap="nowrap" data-column="4">Date</th>
      </tr>
      </thead>
      <tbody class="hostel-deposit sortable-bordy">
