...
@section('script')
    <!-- ajax add subject -->
    <script src="{{ asset('../admin_lang/subject/ajax-add-subject.js')}}?v={{ time() }}"></script> 
    <!-- ajax get all subject  -->
    <script src="{{ asset('../admin_lang/subject/ajax-get-all-subject.js')}}?v={{ time() }}"></script> 
    <!-- ajax delete subject  -->
    <script src="{{ asset('../admin_lang/subject/ajax-delete-subject.js')}}?v={{ time() }}"></script> 
    <!-- ajax Edit subject  -->
    <script src="{{ asset('../admin_lang/subject/ajax-update-subject.js')}}?v={{ time() }}"></script> 
    <!-- script update subject  -->
    <script src="{{ asset('../admin_lang/subject/script-edit-subject.js')}}?v={{ time() }}"></script> 
