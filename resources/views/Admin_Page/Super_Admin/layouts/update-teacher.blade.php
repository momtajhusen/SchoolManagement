...
@section('script')
    <!-- ajax update -->
    <script src="{{ asset('../admin_lang/teacher/ajax-update-teacher.js')}}?v={{ time() }}"></script> 
    ...
    <script src="{{ asset('../admin_lang/common/ImageCrope/Teacher-img-Crope.js')}}?v={{ time() }}"></script> 
