...
@section('script')
    <!-- ajax  -->
    <script src="{{ asset('../admin_lang/teacher/ajax-get-all-teacher.js')}}?v={{ time() }}"></script> 
                        ...
                        <div class="row gutters-8">
                            ...
                            <div class="col-3-xxxl col-xl-3 col-lg-3 col-12 form-group">
                                <select class="select2 teacher-search-select" name="teacher_search_by">
                                    ...
                                    <option value="teacher_mobile">Teacher Mobile .. </option>
                                    <option value="teacher_email">Teacher Email ...</option>
                                </select>
                            </div>
                            <div class="col-4-xxxl col-xl-7 col-lg-3 col-12 form-group">
                                <input type="text" maxlength="30" placeholder="Enter Teacher Name ..." class="form-control teacher-input-search">
                            </div>
