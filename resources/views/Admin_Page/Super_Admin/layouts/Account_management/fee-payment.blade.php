...
@section('script')
    <!-- ajax Reset Payment -->
    <script src="{{ asset('../admin_lang/fees/ajax-reset-payment.js')}}?v={{ time() }}"></script> 

    <!-- ajax Biil  -->
    <script src="{{ asset('../admin_lang/fees/ajax-bill-data.js')}}?v={{ time() }}"></script> 

    <!-- ajax Get Back Year Fee -->
    <script src="{{ asset('../admin_lang/fees/ajax-get-back-year-fee.js')}}?v={{ time() }}"></script> 
    ...
    <script src="{{ asset('../admin_lang/fees/ajax-fee-payment-monthly.js')}}?v={{ time() }}"></script>

    <!-- ajax Multi Pay -->
    <script src="{{ asset('../admin_lang/fees/ajax-multi-pay.js')}}?v={{ time() }}"></script>
    ...
    <!-- ajax joining -->
    <script src="{{ asset('../admin_lang/fees/ajax-joining.js')}}?v={{ time() }}"></script> 

    <!-- ajax priv month invoice -->
    <script src="{{ asset('../admin_lang/fees/ajax-prev-invoice.js')}}?v={{ time() }}"></script> 

        <!-- ajax roll update -->
        <script src="{{ asset('../admin_lang/student/ajax-roll-update.js')}}?v={{ time() }}"></script> 

    <!-- ajax student image change -->
    <script src="{{ asset('../admin_lang/student/student-image-change.js')}}?v={{ time() }}"></script> 
                   ...
                   <div class="p-5" style="background:#d39b7b;width:100%;">
                    <table class="table table-sm" style="width:100%;">
                        ...
                        <tbody class="fee_stracture">
                            ...
                            {{-- Total Fee Type And Amount Retrive Here  --}}
                 ...
                 <div class="p-2 col-lg-6 col-md-12 d-flex justify-content-center">
                    <div class="d-flex flex-column align-items-center justify-content-center" style="width:80%;">
                        ...
                        <div class="w-100 form-group m-1 d-flex justify-content-center mt-4">
                            ...
                            <button  class="d-none bg-success payment-loading" style="width:300px;">
                                <span class="mr-2">process</span> <i class="fa fa-circle-o-notch fa-spin" style="font-size:15px"></i>
                            </button>
                        </div>
                    </div>
                 </div>
                ...
                <table class="table table-sm">
                    <thead>
                        <tr>
                            ...
                            <th scope="col">
                                <div class="d-flex align-content-center">
                                 <span class="material-symbols-outlined">night_shelter </span> H. Deposit
                               </div>
                             </th>
                            <th scope="col">
                               <div class="d-flex align-content-center">
                    ...
                    <tbody>
                        ...
                        <tr class="month_0">
                            ...
                            <td>
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="hosteldeposit-1" value="" id="hosteldeposit-1">
                                    <label class="form-check-label" for="hosteldeposit-1" style='padding-left:20px;'>
                                        Bai.
                                    </label>
                                </div>
                            </td>
                        ...
                        <tr class="month_1">
                            ...
                            <td>
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="hosteldeposit-2" value="" id="hosteldeposit-2">
                                    <label class="form-check-label" for="hosteldeposit-2" style='padding-left:20px;'>
                                        Jes.
                                    </label>
                                </div>
                            </td>
                        ...
                        <tr class="month_2">
                            ...
                            <td>
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="hosteldeposit-3" value="" id="hosteldeposit-3">
                                    <label class="form-check-label" for="hosteldeposit-3" style='padding-left:20px;'>
                                    Ash.
                                    </label>
                                </div>
                            </td>
                        ...
                        <tr class="month_3">
                            ...
                            <td>
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="hosteldeposit-4" value="" id="hosteldeposit-4">
                                    <label class="form-check-label" for="hosteldeposit-4" style='padding-left:20px;'>
                                        Shr.
                                    </label>
                                </div>
                            </td>
                        ...
                        <tr class="month_4">
                            ...
                            <td>
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="hosteldeposit-5" value="" id="hosteldeposit-5">
                                    <label class="form-check-label" for="hosteldeposit-5" style='padding-left:20px;'>
                                        Bha.
                                    </label>
                                </div>
                            </td>
                        ...
                        <td>
                            ...
                            <td>
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="hosteldeposit-6" value="" id="hosteldeposit-6">
                                    <label class="form-check-label" for="hosteldeposit-6" style='padding-left:20px;'>
                                        Aso.
                                    </label>
                                </div>
                            </td>
                        ...
                        <tr class="month_6">
                            ...
                            <td>
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="hosteldeposit-7" value="" id="hosteldeposit-7">
                                    <label class="form-check-label" for="hosteldeposit-7" style='padding-left:20px;'>
                                        Kar.
                                    </label>
                                </div>
                            </td>
                        ...
                        <tr class="month_7">
                            ...
                            <td>
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="hosteldeposit-8" value="" id="hosteldeposit-8">
                                    <label class="form-check-label" for="hosteldeposit-8" style='padding-left:20px;'>
                                        Man.
                                    </label>
                                </div>
                            </td>
                        ...
                        <tr class="month_8">
                            ...
                            <td>
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="hosteldeposit-9" value="" id="hosteldeposit-9">
                                    <label class="form-check-label" for="hosteldeposit-9" style='padding-left:20px;'>
                                        Pou.
                                    </label>
                                </div>
                            </td>
                        ...
                        <tr class="month_9">
                            ...
                            <td>
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="hosteldeposit-10" value="" id="hosteldeposit-10">
                                    <label class="form-check-label" for="hosteldeposit-10" style='padding-left:20px;'>
                                        Mag.
                                    </label>
                                </div>
                            </td>
                        ...
                        <tr class="month_10">
                            ...
                            <td>
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="hosteldeposit-11" value="" id="hosteldeposit-11">
                                    <label class="form-check-label" for="hosteldeposit-11" style='padding-left:20px;'>
                                        Fal.
                                    </label>
                                </div>
                            </td>
                        ...
                        <tr class="month_11">
                            ...
                            <td>
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="hosteldeposit-12" value="" id="hosteldeposit-12">
                                    <label class="form-check-label" for="hosteldeposit-12" style='padding-left:20px;'>
                                        Cha.
                                    </label>
                                </div>
                            </td>
                    ...
                    <div class="col-12 col-md-6 order-1 order-md-2 px-0 mb-2" style="height:125px;">
                      <div class="d-flex p-2 h-100 w-100" style="box-shadow: rgba(0, 0, 0, 0.24) 0px 3px 8px;">
                        ...
                        <div style="position: relative; width:140px;">
                            <img src="http://bit.ly/3IUenmf" id="student_image" class="h-100 w-100">

                            <label for="student_img_input" class="border h-100 w-100 bg-danger" style="position:absolute;left:0px;font-size:15px;cursor:pointer;opacity:0">  
                                <input type="file" id="student_img_input" name="student_image" class="form-control-file">
                                <span class="material-symbols-outlined border" id='image-change' >add_a_photo</span>
                            </label>
                        </div>
                        ...
                        <div class="p-3 w-100" style="position: relative;">
                            ...
                            <div class="w-100">
                                ...
                                <div class='d-flex justify-content-center mt-2'>
                                    <span>Roll:</span> 
                                    <input id="roll" type="text" style='width:40px;height:20px;'>
                                    <span class="material-symbols-outlined" id='roll_update' st_id='#' style='font-size:17px; cursor:pointer;'>update</span>
                                </div>
                                <div class="d-none">
                                ...
                                <span id="transport_use"></span>
                                    <span class="material-symbols-outlined transport-icon d-none service-icon" data-bs-toggle="tooltip" data-bs-placement="top" title="Transpont Use" style="cursor:pointer;"> airport_shuttle</span>
                                    <span class="material-symbols-outlined hostel-icon d-none service-icon" data-bs-toggle="tooltip" data-bs-placement="top" title="Hostel Use" style="cursor:pointer;"> night_shelter</span>
                                    <span class="material-symbols-outlined tuition-icon d-none service-icon" data-bs-toggle="tooltip" data-bs-placement="top" title="Tuition Use" style="cursor:pointer;"> sauna</span>
                                </div> --}}
                                <div class="d-flex justify-content-between">
                                    <div>
                                        <span>st_id :</span> 
            ...
            <div class="modal-body p-0 d-flex justify-content-center" >
                    ...
                    <div class="bill-box" id="my-element" style="background:white; width: 100%; height: 100%; border : 1px solid black; overflow: hidden;">
                        <div style="width: 100%; height: 100%; border : 2px solid black; overflow: hidden;box-sizing:-box;position: relative;">
                            ...
                            {{-- Bill Student and Bill Details Header  --}}
                            <div style="border: 0px solid black; display: flex;">
                                ...
                                {{-- <div style="margin-bottom: 5px;"><b>Bill Months:</b> <span id="bill_month">0</span></div> --}}
                                </div>
                            </div>
                            {{-- Bill Student and Bill Details Header  --}}
...
<script>
    ...
    $('#printBtn').click(function() {
        ...
        }, 2000); // Delay of 0.5 second (1000 ms)
    });
    });
