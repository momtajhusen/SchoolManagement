...
@section('script')
    <!-- ajax  -->
    <script src="{{ asset('../admin_lang/fees/ajax-fee-structure.js')}}?v={{ time() }}"></script>

    <!-- ajax Hostel fee -->
    <script src="{{ asset('../admin_lang/fees/ajax-set-hostel-fee.js')}}?v={{ time() }}"></script>

    <!-- ajax Tuition fee -->
    <script src="{{ asset('../admin_lang/fees/ajax-set-tuition-fee.js')}}?v={{ time() }}"></script>

    <!-- script  -->
    <script src="{{ asset('../admin_lang/fees/script-add-fee.js')}}?v={{ time() }}"></script>
