...
@section('script')
   ...
   <script src="{{ asset('../admin_lang/SelectOption/StudentsParents/all-students.js')}}?v={{ time() }}"></script> 
      ...
      <!-- ajax-student-fee-payment.js -->
      <script src="{{ asset('../admin_lang/Accounts/ajax-update-details.js')}}?v={{ time() }}"></script> 
...
@section('style')
  ...
  <style>
   ...
   .checkbox-wrapper-30 .checkbox {
      ...
      .text-paid{
          color: rgb(160, 250, 142) !important;
      }
      .bg-dues{
         background-color: rgb(250, 239, 142) !important;
      }
      .text-dues{
          color: rgb(250, 239, 142) !important;
      }
      .bg-feenotset{
...
@section('contents')
   ...
   <!-- End Fee Payment  Modal -->
    ...
    <div class="modal fade" id="feeInvoiceModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      ...
      <div class="modal-content" style="background: #02142a;">
         ...
         <div class="modal-body">
             <div class="row m-0 bg-light p-2" style="height: auto;">
               <div class="invoice-content bg-light" style="width:500px;">
                  <div style="padding:10px; border: 2px dashed #000000; height: 750px; position: relative; border-radius: 10px;">
                     ...
                     <div style="display: flex;">
                         <img class="school-logo" src="https://shorturl.at/EoRkI" alt="school-logo" style="width:70px;height:70px;border:1px solid #000000; padding:2px;">
                         <div style="flex-grow: 1; display: flex; flex-direction: column; align-items: center; line-height:20px;">
                             <span class="school-name" style="font-weight: bold; font-size: 20px;">School Name School</span>
                             <span class="school-address" style="font-size:14px;">School Address </span>
                             <span class="school-phone" style="font-size:14px;">Contact</span>
                         </div>
                     </div>
                     <!-- School Details end  -->
                     <!-- Students & date  Start  -->
                     <div style="display: flex; border: solid 1px #ccc; margin-top:10px;">
                         <div style="width:50%;border-right: 1px solid #ccc;padding: 5px;">
                             <div style="margin-bottom:5px;">
                                 <span>Students</span>
                             </div>
                             <div class="invoice-students">

                             </div>

                         </div>
                         <div style="width:50%;border: 0px solid #000000;padding: 5px; display: flex; flex-direction: column; align-items: center; justify-content: center;">
                             <div style="display: flex; flex-direction: column; line-height:25px;">
                                 <span class="pay_date">Date : </span>
                                 <span class="bill_no">Bill No . </span>
                                 <span class="pan_no">Pan No : </span>
                             </div>
                         </div>
                     </div>
                     <!-- Students & date End  -->
                     ...
                     <!-- Table End  -->
                      <!-- Footer Start -->
                        <div style="display: flex; justify-content: space-between;">
                           <div></div>
                           <div style="position: absolute; right: 24px; bottom:15px;">
                             <div style="width:100%; height:30px;; border-bottom: 1px solid #000000; margin-bottom:10px;"></div>
         ...
         <div class="modal-footer">
            ...
            <button type="button" class="btn btn-secondary invoice-print" id="printBtn">
      ...
      <div class="col-12 col-md-5 py-3 border position-relative bg-light">
         ...
         <div class="parent-details-box d-none">
            ...
            <div class="d-flex mt-2">
              ...
              <form class="px-2 parents-details-form" style="line-height:23px;">
                  <div class="d-flex">
                     <span>Father :</span>
                     <input type="text" class="father-name" name='father-name'>
                  </div>
                  <div class="d-flex">
                     <span>Mother :</span>
                     <input type="text" class="mother-name" name="mother-name">
                  </div>
                  <div>
                     <span>Contact :</span>
                     <input type="number" class="father-contact" name="father-contact">
                  </div>
                  <div>
                     <span>Address :</span>
                     <input type="text" class="father-address" name="father-address">
                  </div>
                  <div>
                     <span>pr_id :</span>
                     <input type="text" class="pr-id border-0" readonly name="pr_id">
                   </div>
                   <span class="all_student_st" st_id='#'></span>
    
                   <div class="d-flex">
                     <div class="border p-2 my-3 text-center parent-profile-btn d-flex justify-content-center align-items-center" style="width:150px;cursor:pointer;"></div>
                     <div class="border p-2 my-3 d-flex justify-content-center align-items-center" id="printDuesInvoice" style="width:150px;cursor:pointer;">
                       <span class="material-symbols-outlined mr-1" style="font-size:18px;">print</span>
                       <span>Dues Invoice</span> 
                    </div>
                   </div>


                   <button class="border p-2 my-3 text-center parent-update-btn d-none" type='submit' style="width:150px;cursor:pointer;">Update Parent</button>
              </form>

            </div>
            
            {{-- <button class="deve-use">Fee Check</button> --}}
      ...
      <div class="col-12 col-md-7 py-3 border bg-light">
          ...
          <div class="d-flex justify-content-between">
            <nav>
              ...
              <x-new-account.select-fee-year pr_id="" class="select-fee-year-component" />
          </div>
   ...
   <div class="row pt-3 border bg-light" style="overflow:auto;">
       <div class="col-12"  >
            ...
            <table class="table table-bordered table-responsive-md">
               <thead>
                 <tr class="text-center bg-dark text-light">
                   <th scope="col" id='table-toggle' style="cursor:pointer;"><span class="material-symbols-outlined expend-icon">expand_less</span></th>
                   <th scope="col" nowrap="nowrap">Students</th>
                   <th scope="col" nowrap="nowrap">Year</th>
                   <th scope="col" nowrap="nowrap">Total Fee</th>
                   <th scope="col" nowrap="nowrap">Total Paid</th>
                   <th scope="col" nowrap="nowrap">Total Disc</th>
                   <th scope="col" nowrap="nowrap">Total Dues</th>
                   <th scope="col">Bai</th>
                   <th scope="col">Jes</th>
                   <th scope="col">Ash</th>
                   {{-- <th scope="col" nowrap="nowrap">Session-1</th> --}}
                   <th scope="col">Shr</th>
                   <th scope="col">Bha</th>
                   <th scope="col">Ash</th>
                   {{-- <th scope="col" nowrap="nowrap">Session-2</th> --}}
                   <th scope="col">Kar</th>
                   <th scope="col">Man</th>
                   <th scope="col">Pou</th>
                   {{-- <th scope="col" nowrap="nowrap">Session-3</th> --}}
                   <th scope="col">Mag</th>
                   <th scope="col">Fal</th>
                   <th scope="col">Cha</th>
                   {{-- <th scope="col" nowrap="nowrap">Session-4</th> --}}
                 </tr>
               </thead>
               <tbody class="student-month-fee d-none">
                  {{-- Student Month Fee  --}}
               </tbody>
               <tbody class="total-student-month-fee">
                  {{-- Student Month Fee  --}}
               </tbody>
             </table>
       </div>
   ...
   {{-- Dues Invoice Print  --}}
   <div class="d-none" id="invoice-box" style="position:absolute; z-index:-1; background:white; width: 148mm; height: 250mm; border : 1px solid black;  padding: 0px; margin: 0px;overflow: hidden; ">
