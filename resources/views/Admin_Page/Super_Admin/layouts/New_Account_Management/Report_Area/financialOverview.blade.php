...
@section('script')
    <!-- ajax CheckClassFee -->
    <script src="{{ asset('../admin_lang/Accounts/Report_Area/financial-overview.js')}}?v={{ time() }}"></script>
          ...
          <div class="row">
            <div class="col-12 col-md-4 p-1">
               <div class="w-100 border d-flex align-items-center p-4 revenu-box">
                  <img src="{{ asset('../admin_template_assets/img/revenue.png')}}" alt="Admin" style="width:40px ">
            ...
            <div class="col-12 col-md-4 p-1">
              <div class="w-100 border d-flex align-items-center p-4 expensive-box">
                <img src="{{ asset('../admin_template_assets/img/expensive.png')}}" alt="Admin" style="width:40px ">
                <div class="ml-2 d-flex flex-column" style="line-height:20px;">
            ...
            <div class="col-12 col-md-4 p-1">
              <div class="w-100 border d-flex align-items-center p-4 profit-box">
                <img src="{{ asset('../admin_template_assets/img/profit.png')}}" alt="Admin" style="width:40px ">
                <div class="ml-2 d-flex flex-column" style="line-height:20px;">
