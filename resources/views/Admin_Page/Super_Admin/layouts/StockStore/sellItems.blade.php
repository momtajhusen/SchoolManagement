...
@section('script')
    ...
    <script src="{{ asset('../admin_lang/StockStore/SellItems.js')}}?v={{ time() }}"></script> 

    <script src="{{ asset('../admin_lang/StockStore/AddItemsPrice.js')}}?v={{ time() }}"></script> 

    <script src="{{ asset('../admin_lang/StockStore/History.js')}}?v={{ time() }}"></script> 
        ...
        <div class="col-12 col-md-5 border p-2">
                ...
                <div class="border bg-light w-100 p-5">
                    <div class="student-select-box">
                     ...
                     <div class="border p-1 mt-2 d-none student-details">
                        <img class="border p-2" src="https://images.pexels.com/photos/415829/pexels-photo-415829.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500" alt="student" style="width:80px;">
                        <div class="d-flex flex-column px-2" style="line-height:25px;">
                            <span>Student: Momtaj Husen</span>
                            <span>Father: Momtaj Husen</span>
                            <span>Class: 1ST A</span>
                        </div>
                    </div>
