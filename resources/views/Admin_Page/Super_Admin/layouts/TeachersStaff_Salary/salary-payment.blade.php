...
@section('script')
    <!-- ajax-salaryPayment -->
    <script src="{{ asset('../admin_lang/TeachersStaffSalary/ajax-salaryPayment.js')}}?v={{ time() }}"></script>\
  ...
  <table class="table table-dark table-hover" style="position: relative; width:1200px;">
    <div class="border d-flex justify-content-between  align-items-cenetr p-3 bg-dark text-light" style="width:1200px;">
        <div class="d-flex align-items-start">
           <img class="border mr-2" id="teacher-image" src="{{ asset('storage/CommonImg/employee.jpg') }}" alt="" style="height:50px;width:50px;">
          <div>
            <div class="d-flex">
              <span>Name : </span>
         ...
         <div style="height: 80px;width: 100%; border-bottom:1px solid black;">
           ...
           <div style="border: 0px solid black; display: flex; margin: 10px;">
             ...
             {{-- <div style="margin-top:20px;">
                 <b>Recive Salary in words :</b>
                  <span class="recive_salary_word"></span><br>
             </div> --}}
