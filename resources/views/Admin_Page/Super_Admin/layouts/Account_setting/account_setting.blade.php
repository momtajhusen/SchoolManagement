...
@section('script')
    <!-- ajax  -->
    <script src="{{ asset('../admin_lang/Admin_Account_Setting/authenticationSetting.js')}}?v={{ time() }}"></script> 
            ...
            <div class="w-100 border border-2 p-3 d-flex flex-column content-box">
               <div class="w-100 d-flex justify-content-between">
                   <h5 class="p-0 pt-2 m-0">2-step verification:</h4>
                    <button class="px-5 p-2 edit-btn email-verification-btn" style="width:120px;outline: none; border: none; cursor:pointer;" >Turn on</button>
               </div>
