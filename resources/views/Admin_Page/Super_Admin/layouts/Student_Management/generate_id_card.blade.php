...
@section('script')
    ...
    <script src="{{ asset('../admin_lang/student/ajax-generate_id_card.js')}}?v={{ time() }}"></script> 
                ...
                <div class="card-body">
                    <div class="heading-layout1">
                        ...
                        {{-- <div class="progress-box d-none">
                            <span>Wait For Download</span>
                            <div class="progress" style="height:30px;font-size:14px;">
                                <div class="progress-bar" id="progress-bar" role="progressbar" style="width: 0%;" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100">25%</div>
                              </div>
                        </div> --}}


                        {{-- <div id="processing-percentage">0000</div> --}}
