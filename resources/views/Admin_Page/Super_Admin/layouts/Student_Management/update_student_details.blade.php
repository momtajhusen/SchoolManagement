...
@section('script')
    ...
    <script src="{{ asset('../admin_lang/student_management/ajax-update-student-details.js')}}?v={{ time() }}"></script>
            ...
            <div class="card height-auto">
                <div class="card-body">
                    ...
                    <div id="loader-content d-nonw"></div>
                        ...
                        <input id="student_id" type="hidden" value="{{$id}}">
                            ...
                            <form class="student-update-form" enctype="multipart/form-data">
                                <div class="row">
                                    ...
                                    <div class="col-lg-3 col-12 form-group">
                                        <label>Class *</label>
                                        {{-- <select name="class" readonly required class="selec2 class-select" id="class" style="height:50px;width:100%; padding:10px;">
