...
@section('script')
    <!-- ajax  -->
    <script src="{{ asset('../admin_lang/student/ajax-manage-free-student.js')}}?v={{ time() }}"></script> 

    <!-- Select 2 Js -->
    <script src="{{ asset('../admin_template_assets/js/select2.min.js')}}?v={{ time() }}"></script>

    <!-- Date Picker Js -->
    <script src="{{ asset('../admin_template_assets/js/datepicker.min.js')}}?v={{ time() }}"></script>

    <!-- Data Table Js -->
    <script src="{{ asset('../admin_template_assets/js/jquery.dataTables.min.js')}}?v={{ time() }}"></script>
@endsection
    ...
    <div class="card-body">
            ...
            <div class="row gutters-8">
                ...
                <div class="col-12 col-md-10 form-group">
                    <input type="number" value="{{ isset($id) ? $id : '' }}" id="parent_id" maxlength="30" placeholder="Enter Parent id" class="form-control parents-input-search py-4" style="height:98%;background:#f0f1f3;">
                </div>
