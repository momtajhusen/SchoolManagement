...
@section('script')
    ...
    <!-- script add student  -->
    <script src="{{ asset('../admin_lang/student/script-add-student.js')}}?v={{ time() }}"></script>
    ...
    <script src="{{ asset('../admin_lang/common/ImageCrope/Student-Registration-Crope.js')}}?v={{ time() }}"></script> 
                    ...
                    <div class="item-title d-flex justify-content-between w-100">
                        ...
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right">
                              <a class="dropdown-item d-flex" href="{{route('add-multiple-students')}}">
                                  Upload Multiple 
                              </a>
                            </div>
                        </div>
