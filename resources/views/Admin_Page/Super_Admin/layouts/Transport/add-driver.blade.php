...
@section('script')
    ...
    <!-- ajax  -->
    <script src="{{ asset('../admin_lang/Transport/ajax-add-driver.js')}}?v={{ time() }}"></script> 
    ...
    <script src="{{ asset('../admin_lang/common/ImageCrope/Driver-img-Crope copy.js')}}?v={{ time() }}"></script> 
        ...
        <form class="driver-added-form" enctype="multipart/form-data">
            <div class="row">
                ...
                <div class="col-xl-3 col-lg-6 col-12 form-group">
                    ...
                    <input type="text" required maxlength="10" name="dob" placeholder="yyyy-mm-dd" class="form-control nepali-datepicker">
        ...
        <div class="card height-auto">
            <div class="card-body">
                <div class="d-flex align-items-center justify-content-between">
                        <h2 class="m-0">All Driver</h2>
                        {{-- <button class="btn-fill-lg d-flex btn-gradient-yellow btn-hover-bluedark">
                            <span class="material-symbols-outlined">person_add</span>
                            <span class="mx-3">Add New Teacher</span>
                        </button> --}}
                </div>
