               ...
               <div class="mobile-sidebar-header d-md-none">
                ...
                <div class="sidebar-menu-content" style="height:100vh;">
                    <ul class="nav nav-sidebar-menu sidebar-toggle-view">
                        ...
                        <li class="nav-item {{ request()->routeIs(['teacher-dashboard']) ? 'active-select-menu' : ''}}">
                            <a href="{{route('teacher-dashboard')}}" class="nav-link d-flex align-items-center">
                                <span class="material-symbols-outlined pr-3" style="font-size:25px;">dashboard</span>
                                <span>Dashboard</span>
                            </a>
                        </li>

                        <li class="nav-item {{ request()->routeIs(['exam-marks-entry']) ? 'active-select-menu' : ''}}">
                            <a href="{{route('exam-marks-entry')}}" class="nav-link d-flex align-items-center">
