...
@section('script')
    {{-- <!-- ajax Teacher Details -->
    <script src="{{ asset('../admin_lang/Teacher_Account/ajax-get-teacher-data.js')}}?v={{ time() }}"></script> 
 --}}

        <!-- ajax profile data -->
        <script src="{{ asset('../admin_lang/teacher/ajax-teacher-profile.js')}}?v={{ time() }}"></script> 
...
@section('contents')
   ...
   {{-- <input value="{{$id}}" type="hidden" id="teacher-id"> --}}
   ...
   <div class="row" style="margin-top: 55px;">
      ...
      <div class="col-12 col-md-4 mb-3">
         <div class="px-4 pt-2" style="height:300px;width:100%;border-radius:10px; box-shadow: rgba(99, 99, 99, 0.2) 0px 2px 8px 0px;">
            ...
            {{-- <div>
                <div class="progress" style="height: 20px;border:1px solid #007bff;font-size:14px;">
