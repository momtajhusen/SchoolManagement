...
<body>
        ...
        <div class="d-flex justify-content-center align-items-center" style="width:100vw; height:100vh;">
             <div class="sigin_box login-form-box">
                            ...
                            <div class="tab-content pt-2 d-flex flex-column align-items-center justify-content-start" style="height:500px;">
                                ...
                                <div class="tab-pane fade show p-3  w-100" id="tab7" role="tabpanel">
                                    ...
                                    <form class="super-admin-form" style="height:300px;">
                                        ...
                                        {{-- Load  --}}
                                          <div class="alert alert-success loader d-none" role="alert">
                                            Please Wait ...
                                          </div>
             ...
             <div class="sigin_box ml-3 verification-box d-none">
                <div class="card ui-tab-card h-100 p-0" >
                    <div class="card-body py-5 card-container">


                        <div class="d-flex flex-column">
                            <h4 class="text-light">Let's get you authenticated!</span>

                             <br><br><br>
                            <span class="mt-2">6-digit security code</span>
                            <div class="form-group position-relative mt-5">
                                <label class="text-light">your one time password is send to your login email</label>
                                <input type="number" required name="verification" id="super-admin-verification" placeholder="Enter" class="form-control w-100">
                            </div>
                            <span class="text-danger d-none" id='verify-message'>incorrect code !</span>
                        {{-- Load  --}}
                           <div class="alert alert-success loader d-none" role="alert">
                              Please Wait ...
                            </div>
                            <div class="form-group">
                                <input type="submit" class="form-control w-100 verify-btn" email='#' psd='#' name="capacity" value="verify">
                            </div>
                        </div>
