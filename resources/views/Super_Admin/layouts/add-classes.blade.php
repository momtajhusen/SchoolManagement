                        ...
                        <form class="added-class-form">
                            ...
                            <div class="col-xl-3 col-lg-6 col-12 form-group">
                                ...
                                <div class="col-xl-3 col-lg-6 col-12 form-group">
                                    ...
                                    <input type="text" name="start_date" placeholder="dd/mm/yyyy" class="form-control  nepali-datepicker">
                                    <i class="far fa-calendar-alt" style="position:absolute;top:55px;right:30px;"></i>
                                </div>
                                <div class="col-xl-3 col-lg-6 col-12 form-group">
                                    <label>Class Ending on *</label>
                                    <input type="text" name="end_date" placeholder="dd/mm/yyyy" class="form-control  nepali-datepicker">
                                    <i class="far fa-calendar-alt" style="position:absolute;top:55px;right:30px;"></i>
                                </div>
                                <div class="col-xl-3 col-lg-6 col-12 form-group">
