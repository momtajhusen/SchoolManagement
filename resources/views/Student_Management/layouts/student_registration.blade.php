                   ...
                   <div class="card height-auto">
                    <div class="card-body">
                        ...
                        <form class="student-added-form" enctype="multipart/form-data">
                            <div class="row">
                               <div class="col-xl-3 col-lg-6 col-12 form-group border">
                                ...
                                <div class="col-xl-3 col-lg-6 col-12 form-group border">
                                    <label class="text-dark-medium">Upload ID Proof</label>
                                    <input type="file" name="student_id_image" class="form-control-file">
                                </div>
                                ...
                                <div class="col-xl-3 col-lg-6 col-12 form-group border">
                                    ...
                                    <input type="file" required name="father_image" class="form-control-file">
                                </div>
