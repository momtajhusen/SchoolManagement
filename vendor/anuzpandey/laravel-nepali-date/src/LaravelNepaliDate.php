...
class LaravelNepaliDate
{
    ...
    public static function toEnglishYear($year)
    {
        // Example logic to convert a Nepali year to an English year
        // This is a placeholder logic, adjust according to your needs
        $englishYear = $year - 57; // Adjust conversion logic as necessary
        return $englishYear;
    }

    public static function toNepaliYear($year)
    {
        // Example logic to convert a Nepali year to an English year
        // This is a placeholder logic, adjust according to your needs
        $nepaliYear = $year + 57; // Adjust conversion logic as necessary
        return $nepaliYear;
    }
}
